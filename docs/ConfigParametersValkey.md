...
json = "{}"
# create an instance of ConfigParametersValkey from a JSON string
config_parameters_valkey_instance = ConfigParametersValkey.from_json(json)
# print the JSON string representation of the object
print ConfigParametersValkey.to_json()

# convert the object into a dict
config_parameters_valkey_dict = config_parameters_valkey_instance.to_dict()
# create an instance of ConfigParametersValkey from a dict
config_parameters_valkey_form_dict = config_parameters_valkey.from_dict(config_parameters_valkey_dict)
```
