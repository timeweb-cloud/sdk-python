...
class Deploy(BaseModel):
    ...
    Deploy
    """
    app_id: Optional[Any] = Field(..., description="Идентификатор приложения.")
    commit_sha: Optional[Any] = Field(..., description="Хэш коммита.")
    id: Optional[Any] = Field(..., description="Идентификатор.")
    started_at: Optional[Any] = Field(..., description="Время запуска деплоя.")
    ended_at: Optional[Any] = Field(..., description="Время окончания деплоя. Определено для завершенных деплоев")
    status: DeployStatus = Field(...)
    commit_msg: Optional[Any] = Field(..., description="Сообщение коммита.")
    __properties = ["app_id", "commit_sha", "id", "started_at", "ended_at", "status", "commit_msg"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Deploy:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.commit_msg is None and "commit_msg" in self.__fields_set__:
            _dict['commit_msg'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> Deploy:
        """Create an instance of Deploy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Deploy.parse_obj(obj)

        _obj = Deploy.parse_obj({
