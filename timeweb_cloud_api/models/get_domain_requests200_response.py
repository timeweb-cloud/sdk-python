...
class GetDomainRequests200Response(BaseModel):
    """
    GetDomainRequests200Response
    """
    meta: Meta = Field(...)
    requests: Optional[Any] = Field(...)
    __properties = ["meta", "requests"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDomainRequests200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDomainRequests200Response:
        """Create an instance of GetDomainRequests200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDomainRequests200Response.parse_obj(obj)

        _obj = GetDomainRequests200Response.parse_obj({
