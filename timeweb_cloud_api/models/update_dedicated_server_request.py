...
class UpdateDedicatedServerRequest(BaseModel):
    """
    UpdateDedicatedServerRequest
    """
    name: Optional[Any] = Field(None, description="Удобочитаемое имя выделенного сервера. Максимальная длина — 255 символов, имя должно быть уникальным.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDedicatedServerRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDedicatedServerRequest:
        """Create an instance of UpdateDedicatedServerRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDedicatedServerRequest.parse_obj(obj)

        _obj = UpdateDedicatedServerRequest.parse_obj({
            "name": obj.get("name"),
