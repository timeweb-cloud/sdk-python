...
class Knowledgebase(BaseModel):
    ...
    documents: Optional[Any] = Field(..., description="Документы в базе знаний")
    ...
    __properties = ["id", "name", "description", "dbaas_id", "status", "last_sync", "total_tokens", "used_tokens", "remaining_tokens", "token_package_id", "subscription_renewal_date", "documents", "agents_ids", "created_at"]
