...
class UpdateAuthRestrictionsByCountriesRequest(BaseModel):
    """
    UpdateAuthRestrictionsByCountriesRequest
    """
    is_enabled: Optional[Any] = Field(..., description="Это логическое значение, которое показывает, включены ли ограничения по IP-адресу.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAuthRestrictionsByCountriesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAuthRestrictionsByCountriesRequest:
        """Create an instance of UpdateAuthRestrictionsByCountriesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAuthRestrictionsByCountriesRequest.parse_obj(obj)

        _obj = UpdateAuthRestrictionsByCountriesRequest.parse_obj({
