...
class DatabaseClusterDiskStats(BaseModel):
    """
    Статистика использования диска кластера базы данных.
    """
    size: Optional[Any] = Field(..., description="Размер (в Кб) диска кластера базы данных.")
    used: Optional[Any] = Field(..., description="Размер (в Кб) использованного пространства диска кластера базы данных.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatabaseClusterDiskStats:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatabaseClusterDiskStats:
        """Create an instance of DatabaseClusterDiskStats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatabaseClusterDiskStats.parse_obj(obj)

        _obj = DatabaseClusterDiskStats.parse_obj({
            "size": obj.get("size"),
            "used": obj.get("used")
        })
        return _obj
