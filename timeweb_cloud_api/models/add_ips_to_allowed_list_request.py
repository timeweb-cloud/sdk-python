...
class AddIPsToAllowedListRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddIPsToAllowedListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddIPsToAllowedListRequest:
        """Create an instance of AddIPsToAllowedListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddIPsToAllowedListRequest.parse_obj(obj)

        _obj = AddIPsToAllowedListRequest.parse_obj({
            "ips": obj.get("ips")
        })
        return _obj
