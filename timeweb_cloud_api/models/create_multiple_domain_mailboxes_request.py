...
class CreateMultipleDomainMailboxesRequest(BaseModel):
    """
    CreateMultipleDomainMailboxesRequest
    """
    mailboxes: Optional[Any] = Field(..., description="Массив объектов с данными почтовых ящиков")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMultipleDomainMailboxesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMultipleDomainMailboxesRequest:
        """Create an instance of CreateMultipleDomainMailboxesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMultipleDomainMailboxesRequest.parse_obj(obj)

        _obj = CreateMultipleDomainMailboxesRequest.parse_obj({
