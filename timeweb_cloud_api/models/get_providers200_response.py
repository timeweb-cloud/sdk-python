...
class GetProviders200Response(BaseModel):
    ...
    """
    meta: Meta = Field(...)
    providers: Optional[Any] = Field(...)
    __properties = ["meta", "providers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetProviders200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetProviders200Response:
        """Create an instance of GetProviders200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetProviders200Response.parse_obj(obj)

        _obj = GetProviders200Response.parse_obj({
