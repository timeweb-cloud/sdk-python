...
class ModelParamsInfoMaxTokens(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelParamsInfoMaxTokens:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelParamsInfoMaxTokens:
        """Create an instance of ModelParamsInfoMaxTokens from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelParamsInfoMaxTokens.parse_obj(obj)

        _obj = ModelParamsInfoMaxTokens.parse_obj({
            "type": obj.get("type"),
            "min": obj.get("min"),
            "max": obj.get("max"),
