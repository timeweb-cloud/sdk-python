...
class GetApp200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetApp200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetApp200Response:
        """Create an instance of GetApp200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetApp200Response.parse_obj(obj)

        _obj = GetApp200Response.parse_obj({
            "app": obj.get("app")
        })
        return _obj
