...
class GetDatabaseInstances200Response(BaseModel):
    """
    GetDatabaseInstances200Response
    """
    meta: Meta = Field(...)
    instances: Optional[Any] = Field(...)
    __properties = ["meta", "instances"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDatabaseInstances200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDatabaseInstances200Response:
        """Create an instance of GetDatabaseInstances200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDatabaseInstances200Response.parse_obj(obj)

        _obj = GetDatabaseInstances200Response.parse_obj({
