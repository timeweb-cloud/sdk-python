...
class ConfigParametersValkey(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigParametersValkey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigParametersValkey:
        """Create an instance of ConfigParametersValkey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigParametersValkey.parse_obj(obj)

        _obj = ConfigParametersValkey.parse_obj({
