...
class NotificationSettingChannel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationSettingChannel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationSettingChannel:
        """Create an instance of NotificationSettingChannel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationSettingChannel.parse_obj(obj)

        _obj = NotificationSettingChannel.parse_obj({
        })
        return _obj
