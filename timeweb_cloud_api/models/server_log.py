...
class ServerLog(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerLog:
    ...
    def to_dict(self):
        ...
        # set to None if logged_at (nullable) is None
        # and __fields_set__ contains the field
        if self.logged_at is None and "logged_at" in self.__fields_set__:
            _dict['logged_at'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerLog:
        """Create an instance of ServerLog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerLog.parse_obj(obj)

        _obj = ServerLog.parse_obj({
            "id": obj.get("id"),
