...
class NotificationSettingType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationSettingType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationSettingType:
        """Create an instance of NotificationSettingType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationSettingType.parse_obj(obj)

        _obj = NotificationSettingType.parse_obj({
        })
        return _obj
