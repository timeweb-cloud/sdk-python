...
class GetRepositories200Response(BaseModel):
    """
    GetRepositories200Response
    """
    meta: Meta = Field(...)
    repositories: Optional[Any] = Field(...)
    __properties = ["meta", "repositories"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRepositories200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRepositories200Response:
        """Create an instance of GetRepositories200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRepositories200Response.parse_obj(obj)

        _obj = GetRepositories200Response.parse_obj({
