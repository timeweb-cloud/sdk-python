...
class CreateVPC201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVPC201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVPC201Response:
        """Create an instance of CreateVPC201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateVPC201Response.parse_obj(obj)

        _obj = CreateVPC201Response.parse_obj({
            "vpc": Vpc.from_dict(obj.get("vpc")) if obj.get("vpc") is not None else None
        })
        return _obj
