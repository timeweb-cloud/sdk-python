...
class EditApiKey(BaseModel):
    """
    EditApiKey
    """
    name: Optional[Any] = Field(None, description="Имя, установленное для токена.")
    ...
    __properties = ["name", "is_able_to_delete"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditApiKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EditApiKey:
        """Create an instance of EditApiKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EditApiKey.parse_obj(obj)

        _obj = EditApiKey.parse_obj({
            "name": obj.get("name"),
