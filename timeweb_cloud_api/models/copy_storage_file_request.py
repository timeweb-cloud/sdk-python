...
class CopyStorageFileRequest(BaseModel):
    """
    CopyStorageFileRequest
    """
    destination: Optional[Any] = Field(..., description="Новый путь до файлов.")
    source: Optional[Any] = Field(...)
    __properties = ["destination", "source"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CopyStorageFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CopyStorageFileRequest:
        """Create an instance of CopyStorageFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CopyStorageFileRequest.parse_obj(obj)

        _obj = CopyStorageFileRequest.parse_obj({
