...
class GetProjectStorages200Response(BaseModel):
    """
    GetProjectStorages200Response
    """
    buckets: Optional[Any] = Field(...)
    meta: Meta = Field(...)
    __properties = ["buckets", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetProjectStorages200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetProjectStorages200Response:
        """Create an instance of GetProjectStorages200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetProjectStorages200Response.parse_obj(obj)

        _obj = GetProjectStorages200Response.parse_obj({
