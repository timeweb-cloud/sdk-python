...
class CreateInstance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateInstance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateInstance:
        """Create an instance of CreateInstance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateInstance.parse_obj(obj)

        _obj = CreateInstance.parse_obj({
            "name": obj.get("name"),
