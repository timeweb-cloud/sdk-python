...
class PresetsResponse(BaseModel):
    ...
    k8s_presets: Optional[Any] = Field(..., description="Массив тарифов k8s")
    __properties = ["response_id", "meta", "k8s_presets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetsResponse:
    ...
    def to_dict(self):
        ...
        # set to None if k8s_presets (nullable) is None
        # and __fields_set__ contains the field
        if self.k8s_presets is None and "k8s_presets" in self.__fields_set__:
            _dict['k8s_presets'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> PresetsResponse:
        """Create an instance of PresetsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetsResponse.parse_obj(obj)

        _obj = PresetsResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "meta": SchemasMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "k8s_presets": obj.get("k8s_presets")
        })
        return _obj
