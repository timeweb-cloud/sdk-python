...
class UpdateToken200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateToken200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateToken200Response:
        """Create an instance of UpdateToken200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateToken200Response.parse_obj(obj)

        _obj = UpdateToken200Response.parse_obj({
