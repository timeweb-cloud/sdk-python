...
class GetDatabaseUsers200Response(BaseModel):
    """
    GetDatabaseUsers200Response
    """
    meta: Meta = Field(...)
    admins: Optional[Any] = Field(...)
    __properties = ["meta", "admins"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDatabaseUsers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDatabaseUsers200Response:
        """Create an instance of GetDatabaseUsers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDatabaseUsers200Response.parse_obj(obj)

        _obj = GetDatabaseUsers200Response.parse_obj({
