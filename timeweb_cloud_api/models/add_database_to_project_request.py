...
class AddDatabaseToProjectRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddDatabaseToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddDatabaseToProjectRequest:
        """Create an instance of AddDatabaseToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddDatabaseToProjectRequest.parse_obj(obj)

        _obj = AddDatabaseToProjectRequest.parse_obj({
