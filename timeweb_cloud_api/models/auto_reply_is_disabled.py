...
class AutoReplyIsDisabled(BaseModel):
    ...
    message: Optional[Any] = Field(None, description="Сообщение автоответчика на входящие письма")
    subject: Optional[Any] = Field(None, description="Тема сообщения автоответчика на входящие письма.")
