...
class UpdateVpc(BaseModel):
    """
    UpdateVpc
    """
    name: Optional[Any] = Field(None, description="Имя сети.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateVpc:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateVpc:
        """Create an instance of UpdateVpc from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateVpc.parse_obj(obj)

        _obj = UpdateVpc.parse_obj({
            "name": obj.get("name"),
