...
class AvailableNetwork(BaseModel):
    """
    AvailableNetwork
    """
    id: Optional[Any] = Field(..., description="ID сети")
    description: Optional[Any] = Field(..., description="Описание сети")
    name: Optional[Any] = Field(..., description="Имя сети")
    subnet_v4: Optional[Any] = Field(..., description="Подсеть IPv4")
    location: Optional[Any] = Field(..., description="Локация")
    created_at: Optional[Any] = Field(..., description="Дата и время создания")
    availability_zone: Optional[Any] = Field(..., description="Зона доступности")
    public_ip: Optional[Any] = Field(..., description="Публичный IP-адрес")
    type: Optional[Any] = Field(..., description="Тип сети")
    busy_address: Optional[Any] = Field(..., description="Занятые IP-адреса")
    __properties = ["id", "description", "name", "subnet_v4", "location", "created_at", "availability_zone", "public_ip", "type", "busy_address"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableNetwork:
    ...
    def to_dict(self):
        ...
        # set to None if subnet_v4 (nullable) is None
        # and __fields_set__ contains the field
        if self.subnet_v4 is None and "subnet_v4" in self.__fields_set__:
            _dict['subnet_v4'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableNetwork:
        """Create an instance of AvailableNetwork from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableNetwork.parse_obj(obj)

        _obj = AvailableNetwork.parse_obj({
            "id": obj.get("id"),
