...
class FirewallGroupInAPI(BaseModel):
    """
    FirewallGroupInAPI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallGroupInAPI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallGroupInAPI:
        """Create an instance of FirewallGroupInAPI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallGroupInAPI.parse_obj(obj)

        _obj = FirewallGroupInAPI.parse_obj({
            "name": obj.get("name"),
