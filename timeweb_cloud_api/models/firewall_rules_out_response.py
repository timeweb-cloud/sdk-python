...
class FirewallRulesOutResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallRulesOutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallRulesOutResponse:
        """Create an instance of FirewallRulesOutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallRulesOutResponse.parse_obj(obj)

        _obj = FirewallRulesOutResponse.parse_obj({
