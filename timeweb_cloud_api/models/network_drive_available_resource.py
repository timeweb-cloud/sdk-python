...
class NetworkDriveAvailableResource(BaseModel):
    """
    NetworkDriveAvailableResource
    """
    resource_id: Optional[Any] = Field(..., description="Уникальный идентификатор сервиса.")
    resource_type: Optional[Any] = Field(..., description="Тип ресурса.")
    ip: Optional[Any] = Field(None, description="IP-адрес сервиса.")
    availability_zone: AvailabilityZone = Field(...)
    __properties = ["resource_id", "resource_type", "ip", "availability_zone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDriveAvailableResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDriveAvailableResource:
        """Create an instance of NetworkDriveAvailableResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDriveAvailableResource.parse_obj(obj)

        _obj = NetworkDriveAvailableResource.parse_obj({
