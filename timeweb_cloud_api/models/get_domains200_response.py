...
class GetDomains200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDomains200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDomains200Response:
        """Create an instance of GetDomains200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDomains200Response.parse_obj(obj)

        _obj = GetDomains200Response.parse_obj({
