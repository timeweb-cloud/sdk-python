...
class RouterOut(BaseModel):
    ...
    RouterOut
    """
    id: Optional[Any] = Field(..., description="ID роутера")
    account_id: Optional[Any] = Field(..., description="ID аккаунта")
    avatar_link: Optional[Any] = Field(..., description="Ссылка на аватар роутера")
    name: Optional[Any] = Field(..., description="Имя роутера")
    comment: Optional[Any] = Field(..., description="Описание роутера")
    status: Optional[Any] = Field(..., description="Статус роутера")
    zone: Optional[Any] = Field(..., description="Зона доступности")
    ips: Optional[Any] = Field(..., description="IP-адреса")
    preset_id: Optional[Any] = Field(..., description="ID тарифа")
    preset: RouterPreset = Field(...)
    nodes: Optional[Any] = Field(..., description="Ноды")
    networks: Optional[Any] = Field(..., description="Сети")
    created_at: Optional[Any] = Field(..., description="Дата и время создания роутера в формате ISO8601")
    project_id: Optional[Any] = Field(None, description="ID проекта")
    parent_services: Optional[Any] = Field(..., description="Родительские сервисы")
    __properties = ["id", "account_id", "avatar_link", "name", "comment", "status", "zone", "ips", "preset_id", "preset", "nodes", "networks", "created_at", "project_id", "parent_services"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RouterOut:
    ...
    def to_dict(self):
        ...
        # set to None if parent_services (nullable) is None
        # and __fields_set__ contains the field
        if self.parent_services is None and "parent_services" in self.__fields_set__:
            _dict['parent_services'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> RouterOut:
        """Create an instance of RouterOut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RouterOut.parse_obj(obj)

        _obj = RouterOut.parse_obj({
            "id": obj.get("id"),
            ...
            "preset": RouterPreset.from_dict(obj.get("preset")) if obj.get("preset") is not None else None,
            "nodes": obj.get("nodes"),
            "networks": obj.get("networks"),
            "created_at": obj.get("created_at"),
            "project_id": obj.get("project_id"),
            "parent_services": obj.get("parent_services")
        })
        return _obj
