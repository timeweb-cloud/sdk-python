...
class AddBitbucket(BaseModel):
    ...
    def provider_type_validate_enum(cls, value):
        ...
        if value not in ('bitbucket'):
            raise ValueError("must be one of enum values ('bitbucket')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddBitbucket:
    ...
    def to_dict(self):
        ...
        # set to None if provider_token (nullable) is None
        # and __fields_set__ contains the field
        if self.provider_token is None and "provider_token" in self.__fields_set__:
            _dict['provider_token'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddBitbucket:
        """Create an instance of AddBitbucket from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddBitbucket.parse_obj(obj)

        _obj = AddBitbucket.parse_obj({
