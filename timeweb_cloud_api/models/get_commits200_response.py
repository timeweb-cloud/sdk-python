...
class GetCommits200Response(BaseModel):
    """
    GetCommits200Response
    """
    meta: Meta = Field(...)
    commits: Optional[Any] = Field(...)
    __properties = ["meta", "commits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCommits200Response:
    ...
    def to_dict(self):
        ...
        if self.commits is None and "commits" in self.__fields_set__:
            _dict['commits'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> GetCommits200Response:
        """Create an instance of GetCommits200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCommits200Response.parse_obj(obj)

        _obj = GetCommits200Response.parse_obj({
