...
class NetworkIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkIn:
        """Create an instance of NetworkIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkIn.parse_obj(obj)

        _obj = NetworkIn.parse_obj({
