...
class GetStorageFilesList200Response(BaseModel):
    """
    GetStorageFilesList200Response
    """
    files: Optional[Any] = Field(...)
    meta: Meta = Field(...)
    __properties = ["files", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStorageFilesList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStorageFilesList200Response:
        """Create an instance of GetStorageFilesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStorageFilesList200Response.parse_obj(obj)

        _obj = GetStorageFilesList200Response.parse_obj({
            "files": obj.get("files"),
