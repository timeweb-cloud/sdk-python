...
class GetMailboxes200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMailboxes200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMailboxes200Response:
        """Create an instance of GetMailboxes200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetMailboxes200Response.parse_obj(obj)

        _obj = GetMailboxes200Response.parse_obj({
