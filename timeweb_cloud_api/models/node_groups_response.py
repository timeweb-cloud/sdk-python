...
class NodeGroupsResponse(BaseModel):
    ...
    node_groups: Optional[Any] = Field(..., description="Массив объектов Группа нод")
    __properties = ["response_id", "meta", "node_groups"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeGroupsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeGroupsResponse:
        """Create an instance of NodeGroupsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeGroupsResponse.parse_obj(obj)

        _obj = NodeGroupsResponse.parse_obj({
