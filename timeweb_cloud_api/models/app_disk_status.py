...
class AppDiskStatus(BaseModel):
    ...
    disk_id: Optional[Any] = Field(None, description="Идентификатор диска.")
    __properties = ["used", "size", "disk_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppDiskStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppDiskStatus:
        """Create an instance of AppDiskStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppDiskStatus.parse_obj(obj)

        _obj = AppDiskStatus.parse_obj({
            "used": obj.get("used"),
            "size": obj.get("size"),
