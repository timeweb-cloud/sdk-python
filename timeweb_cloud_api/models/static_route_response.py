...
class StaticRouteResponse(BaseModel):
    ...
    static_route: StaticRouteOut = Field(...)
    __properties = ["response_id", "static_route"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StaticRouteResponse:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of static_route
        if self.static_route:
            _dict['static_route'] = self.static_route.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StaticRouteResponse:
        """Create an instance of StaticRouteResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StaticRouteResponse.parse_obj(obj)

        _obj = StaticRouteResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "static_route": StaticRouteOut.from_dict(obj.get("static_route")) if obj.get("static_route") is not None else None
        })
        return _obj
