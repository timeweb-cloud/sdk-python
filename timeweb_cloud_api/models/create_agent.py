...
class CreateAgent(BaseModel):
    ...
    __properties = ["name", "description", "access_type", "model_id", "token_package_id", "settings", "project_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAgent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAgent:
        """Create an instance of CreateAgent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAgent.parse_obj(obj)

        _obj = CreateAgent.parse_obj({
            "name": obj.get("name"),
