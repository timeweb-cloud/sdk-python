...
class ServersSoftwareRequirements(BaseModel):
    """
    Требования к облачному серверу для установки ПО.
    """
    cpu_min: Optional[Any] = Field(None, description="Минимальной значение процессора.")
    disk_min: Optional[Any] = Field(None, description="Минимальное значение диска.")
    ram_min: Optional[Any] = Field(None, description="Минимальное значение оперативной памяти.")
    bandwidth_min: Optional[Any] = Field(None, description="Минимальное значение пропускной способности.")
    __properties = ["cpu_min", "disk_min", "ram_min", "bandwidth_min"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServersSoftwareRequirements:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.bandwidth_min is None and "bandwidth_min" in self.__fields_set__:
            _dict['bandwidth_min'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ServersSoftwareRequirements:
        """Create an instance of ServersSoftwareRequirements from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServersSoftwareRequirements.parse_obj(obj)

        _obj = ServersSoftwareRequirements.parse_obj({
