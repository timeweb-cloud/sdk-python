...
class CreateClusterAdmin(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateClusterAdmin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateClusterAdmin:
        """Create an instance of CreateClusterAdmin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateClusterAdmin.parse_obj(obj)

        _obj = CreateClusterAdmin.parse_obj({
            "login": obj.get("login"),
