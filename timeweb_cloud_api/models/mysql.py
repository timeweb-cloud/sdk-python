...
class Mysql(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Mysql:
        """Create an instance of Mysql from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Mysql:
        """Create an instance of Mysql from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Mysql.parse_obj(obj)

        _obj = Mysql.parse_obj({
