...
class SettingCondition(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SettingCondition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SettingCondition:
        """Create an instance of SettingCondition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SettingCondition.parse_obj(obj)

        _obj = SettingCondition.parse_obj({
        })
        return _obj
