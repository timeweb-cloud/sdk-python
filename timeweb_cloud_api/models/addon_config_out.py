...
class AddonConfigOut(BaseModel):
    """
    AddonConfigOut
    """
    id: Optional[Any] = Field(..., description="ID конфигурации дополнения")
    type: Optional[Any] = Field(..., description="Тип дополнения")
    version: Optional[Any] = Field(..., description="Версия дополнения")
    dependencies: Optional[Any] = Field(..., description="Зависимости дополнения")
    yaml_config: Optional[Any] = Field(..., description="YAML конфигурации дополнения")
    __properties = ["id", "type", "version", "dependencies", "yaml_config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddonConfigOut:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddonConfigOut:
        """Create an instance of AddonConfigOut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddonConfigOut.parse_obj(obj)

        _obj = AddonConfigOut.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
