...
class NetworkDrive(BaseModel):
    """
    NetworkDrive
    """
    id: Optional[Any] = Field(..., description="Идентификатор сетевого диска.")
    ...
    service_list: Optional[Any] = Field(..., description="Список сервисов к которым подключен диск.")
    location: Optional[Any] = Field(..., description="Локация сетевого диска.")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('new', 'created', 'failed'):
            raise ValueError("must be one of enum values ('new', 'created', 'failed')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDrive:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.service_list is None and "service_list" in self.__fields_set__:
            _dict['service_list'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDrive:
        """Create an instance of NetworkDrive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDrive.parse_obj(obj)

        _obj = NetworkDrive.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "comment": obj.get("comment"),
            "size": obj.get("size"),
            "service_list": obj.get("service_list"),
