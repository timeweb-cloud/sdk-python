...
class CreateKnowledgebase(BaseModel):
    ...
    dbaas_preset_id: Optional[Any] = Field(..., description="ID пресета базы данных")
    network_id: Optional[Any] = Field(..., description="ID сети")
    ...
    __properties = ["name", "description", "dbaas_preset_id", "network_id", "token_package_id", "project_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateKnowledgebase:
    ...
    def to_dict(self):
        ...
        # set to None if dbaas_preset_id (nullable) is None
        # and __fields_set__ contains the field
        if self.dbaas_preset_id is None and "dbaas_preset_id" in self.__fields_set__:
            _dict['dbaas_preset_id'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateKnowledgebase:
        """Create an instance of CreateKnowledgebase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateKnowledgebase.parse_obj(obj)

        _obj = CreateKnowledgebase.parse_obj({
            "name": obj.get("name"),
            "description": obj.get("description"),
            "dbaas_preset_id": obj.get("dbaas_preset_id"),
