...
class AddProvider201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddProvider201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddProvider201Response:
        """Create an instance of AddProvider201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddProvider201Response.parse_obj(obj)

        _obj = AddProvider201Response.parse_obj({
