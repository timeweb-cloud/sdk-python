...
class AddStorageSubdomainsRequest(BaseModel):
    """
    AddStorageSubdomainsRequest
    """
    subdomains: Optional[Any] = Field(...)
    __properties = ["subdomains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddStorageSubdomainsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddStorageSubdomainsRequest:
        """Create an instance of AddStorageSubdomainsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddStorageSubdomainsRequest.parse_obj(obj)

        _obj = AddStorageSubdomainsRequest.parse_obj({
