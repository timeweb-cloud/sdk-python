...
class CreateDomainDNSRecord201Response(BaseModel):
    """
    CreateDomainDNSRecord201Response
    """
    dns_record: DnsRecord = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDomainDNSRecord201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDomainDNSRecord201Response:
        """Create an instance of CreateDomainDNSRecord201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDomainDNSRecord201Response.parse_obj(obj)

        _obj = CreateDomainDNSRecord201Response.parse_obj({
            "dns_record": DnsRecord.from_dict(obj.get("dns_record")) if obj.get("dns_record") is not None else None
        })
        return _obj
