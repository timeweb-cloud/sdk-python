...
class GetApps200Response(BaseModel):
    ...
    """
    meta: Meta = Field(...)
    apps: Optional[Any] = Field(...)
    __properties = ["meta", "apps"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetApps200Response:
    ...
    def to_dict(self):
        ...
        if self.apps is None and "apps" in self.__fields_set__:
            _dict['apps'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> GetApps200Response:
        """Create an instance of GetApps200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetApps200Response.parse_obj(obj)

        _obj = GetApps200Response.parse_obj({
