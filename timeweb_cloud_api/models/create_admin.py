...
class CreateAdmin(BaseModel):
    ...
    instance_id: Optional[Any] = Field(None, description="ID инстанса базы данных для применения привилегий. Если поле не передано, то привилегии будут применены ко всем инстансам")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAdmin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAdmin:
        """Create an instance of CreateAdmin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAdmin.parse_obj(obj)

        _obj = CreateAdmin.parse_obj({
            "login": obj.get("login"),
