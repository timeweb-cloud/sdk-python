...
class CreateDatabase201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDatabase201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDatabase201Response:
        """Create an instance of CreateDatabase201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDatabase201Response.parse_obj(obj)

        _obj = CreateDatabase201Response.parse_obj({
            "db": Db.from_dict(obj.get("db")) if obj.get("db") is not None else None
        })
        return _obj
