...
class CreateServerDiskBackup201Response(BaseModel):
    """
    CreateServerDiskBackup201Response
    """
    backup: Optional[ServerBackup] = None
    __properties = ["backup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateServerDiskBackup201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateServerDiskBackup201Response:
        """Create an instance of CreateServerDiskBackup201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateServerDiskBackup201Response.parse_obj(obj)

        _obj = CreateServerDiskBackup201Response.parse_obj({
            "backup": ServerBackup.from_dict(obj.get("backup")) if obj.get("backup") is not None else None
        })
        return _obj
