...
class MailboxAutoReply(BaseModel):
    """
    Автоответчик на входящие письма
    """
    is_enabled: Optional[Any] = Field(..., description="Включен ли автоответчик на входящие письма")
    message: Optional[Any] = Field(..., description="Сообщение автоответчика на входящие письма")
    subject: Optional[Any] = Field(..., description="Тема сообщения автоответчика на входящие письма")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailboxAutoReply:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailboxAutoReply:
        """Create an instance of MailboxAutoReply from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailboxAutoReply.parse_obj(obj)

        _obj = MailboxAutoReply.parse_obj({
