...
class CreateDomainMailboxV2201Response(BaseModel):
    """
    CreateDomainMailboxV2201Response
    """
    mailbox: MailboxV2 = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDomainMailboxV2201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDomainMailboxV2201Response:
        """Create an instance of CreateDomainMailboxV2201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDomainMailboxV2201Response.parse_obj(obj)

        _obj = CreateDomainMailboxV2201Response.parse_obj({
            "mailbox": MailboxV2.from_dict(obj.get("mailbox")) if obj.get("mailbox") is not None else None
        })
        return _obj
