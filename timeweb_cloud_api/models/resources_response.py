...
class ResourcesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourcesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourcesResponse:
        """Create an instance of ResourcesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourcesResponse.parse_obj(obj)

        _obj = ResourcesResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "resources": Resources.from_dict(obj.get("resources")) if obj.get("resources") is not None else None
        })
        return _obj
