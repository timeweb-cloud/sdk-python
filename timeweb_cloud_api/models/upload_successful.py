...
class UploadSuccessful(BaseModel):
    """
    UploadSuccessful
    """
    image_id: Optional[Any] = Field(...)
    __properties = ["image_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadSuccessful:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadSuccessful:
        """Create an instance of UploadSuccessful from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UploadSuccessful.parse_obj(obj)

        _obj = UploadSuccessful.parse_obj({
