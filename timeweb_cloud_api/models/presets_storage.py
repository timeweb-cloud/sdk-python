...
class PresetsStorage(BaseModel):
    """
    Тариф
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор для каждого экземпляра тарифа хранилища.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetsStorage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PresetsStorage:
        """Create an instance of PresetsStorage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetsStorage.parse_obj(obj)

        _obj = PresetsStorage.parse_obj({
            "id": obj.get("id"),
