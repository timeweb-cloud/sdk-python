...
class UpdateInstance(BaseModel):
    ...
    UpdateInstance
    """
    name: Optional[Any] = Field(None, description="Название инстанса базы данных")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateInstance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateInstance:
        """Create an instance of UpdateInstance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateInstance.parse_obj(obj)

        _obj = UpdateInstance.parse_obj({
            "name": obj.get("name"),
