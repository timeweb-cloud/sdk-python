...
class DedicatedServerPresetDisk(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DedicatedServerPresetDisk:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DedicatedServerPresetDisk:
        """Create an instance of DedicatedServerPresetDisk from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DedicatedServerPresetDisk.parse_obj(obj)
