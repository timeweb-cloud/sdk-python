...
class CreateAgent201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAgent201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAgent201Response:
        """Create an instance of CreateAgent201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAgent201Response.parse_obj(obj)

        _obj = CreateAgent201Response.parse_obj({
