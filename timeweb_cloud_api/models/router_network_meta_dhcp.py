...
class RouterNetworkMetaDhcp(BaseModel):
    """
    DHCP
    """
    is_enabled: Optional[Any] = Field(..., description="Включен ли DHCP")
    is_available: Optional[Any] = Field(..., description="Доступен ли DHCP")
    __properties = ["is_enabled", "is_available"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RouterNetworkMetaDhcp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RouterNetworkMetaDhcp:
        """Create an instance of RouterNetworkMetaDhcp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RouterNetworkMetaDhcp.parse_obj(obj)

        _obj = RouterNetworkMetaDhcp.parse_obj({
