...
class DomainTransfer(BaseModel):
    ...
    __properties = ["action", "auth_code", "fqdn"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainTransfer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainTransfer:
        """Create an instance of DomainTransfer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DomainTransfer.parse_obj(obj)

        _obj = DomainTransfer.parse_obj({
