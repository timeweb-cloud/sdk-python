...
class Commit(BaseModel):
    ...
    Commit
    """
    sha: Optional[Any] = Field(..., description="Хэш коммита.")
    created_at: Optional[Any] = Field(..., description="Значение времени, указанное в комбинированном формате даты и времени ISO8601, которое представляет, когда был создан коммит.")
    message: Optional[Any] = Field(..., description="Сообщение коммита.")
    __properties = ["sha", "created_at", "message"]
    ...
    def to_dict(self):
        ...
        if self.sha is None and "sha" in self.__fields_set__:
            _dict['sha'] = None
