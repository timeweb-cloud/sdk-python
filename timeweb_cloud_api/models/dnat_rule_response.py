...
class DnatRuleResponse(BaseModel):
    ...
    dnat_rule: DnatRuleOut = Field(...)
    __properties = ["response_id", "dnat_rule"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnatRuleResponse:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of dnat_rule
        if self.dnat_rule:
            _dict['dnat_rule'] = self.dnat_rule.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DnatRuleResponse:
        """Create an instance of DnatRuleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnatRuleResponse.parse_obj(obj)

        _obj = DnatRuleResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "dnat_rule": DnatRuleOut.from_dict(obj.get("dnat_rule")) if obj.get("dnat_rule") is not None else None
        })
        return _obj
