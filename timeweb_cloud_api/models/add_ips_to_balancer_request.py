...
class AddIPsToBalancerRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddIPsToBalancerRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddIPsToBalancerRequest:
        """Create an instance of AddIPsToBalancerRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddIPsToBalancerRequest.parse_obj(obj)

        _obj = AddIPsToBalancerRequest.parse_obj({
            "ips": obj.get("ips")
        })
        return _obj
