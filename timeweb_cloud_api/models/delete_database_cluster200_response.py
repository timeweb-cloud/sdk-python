...
class DeleteDatabaseCluster200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteDatabaseCluster200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteDatabaseCluster200Response:
        """Create an instance of DeleteDatabaseCluster200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteDatabaseCluster200Response.parse_obj(obj)

        _obj = DeleteDatabaseCluster200Response.parse_obj({
            "hash": obj.get("hash")
        })
        return _obj
