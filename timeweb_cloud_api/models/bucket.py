...
class Bucket(BaseModel):
    ...
    Хранилище S3
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор для каждого экземпляра хранилища. Автоматически генерируется при создании.")
    ...
    preset_id: Optional[Any] = Field(..., description="Идентификатор тарифа хранилища.")
