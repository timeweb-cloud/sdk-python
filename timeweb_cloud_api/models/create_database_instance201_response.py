...
class CreateDatabaseInstance201Response(BaseModel):
    """
    CreateDatabaseInstance201Response
    """
    instance: DatabaseInstance = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDatabaseInstance201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDatabaseInstance201Response:
        """Create an instance of CreateDatabaseInstance201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDatabaseInstance201Response.parse_obj(obj)

        _obj = CreateDatabaseInstance201Response.parse_obj({
            "instance": DatabaseInstance.from_dict(obj.get("instance")) if obj.get("instance") is not None else None
        })
        return _obj
