...
class ImageDownloadsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageDownloadsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageDownloadsResponse:
        """Create an instance of ImageDownloadsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageDownloadsResponse.parse_obj(obj)

        _obj = ImageDownloadsResponse.parse_obj({
