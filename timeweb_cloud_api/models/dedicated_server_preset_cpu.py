...
class DedicatedServerPresetCpu(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DedicatedServerPresetCpu:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DedicatedServerPresetCpu:
        """Create an instance of DedicatedServerPresetCpu from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DedicatedServerPresetCpu.parse_obj(obj)
