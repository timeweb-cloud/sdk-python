...
class CreateDomainMailbox201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDomainMailbox201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDomainMailbox201Response:
        """Create an instance of CreateDomainMailbox201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDomainMailbox201Response.parse_obj(obj)

        _obj = CreateDomainMailbox201Response.parse_obj({
            "mailbox": Mailbox.from_dict(obj.get("mailbox")) if obj.get("mailbox") is not None else None
        })
        return _obj
