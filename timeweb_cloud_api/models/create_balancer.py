...
class CreateBalancer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBalancer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBalancer:
        """Create an instance of CreateBalancer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBalancer.parse_obj(obj)

        _obj = CreateBalancer.parse_obj({
            "name": obj.get("name"),
            "algo": obj.get("algo"),
