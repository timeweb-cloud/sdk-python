...
class GetCountries200Response(BaseModel):
    ...
    """
    countries: Optional[Any] = Field(..., description="Список стран, приходит в виде объекта, где ключ - код страны в формате Alpha-2 ISO 3166-1, а значение - название страны в удобочитаемом формате.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCountries200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCountries200Response:
        """Create an instance of GetCountries200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCountries200Response.parse_obj(obj)

        _obj = GetCountries200Response.parse_obj({
