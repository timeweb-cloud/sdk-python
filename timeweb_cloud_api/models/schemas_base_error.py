...
class SchemasBaseError(BaseModel):
    """
    SchemasBaseError
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchemasBaseError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchemasBaseError:
        """Create an instance of SchemasBaseError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchemasBaseError.parse_obj(obj)

        _obj = SchemasBaseError.parse_obj({
