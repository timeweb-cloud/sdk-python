...
class UpdateKnowledgebase(BaseModel):
    ...
    """
    name: Optional[Any] = Field(None, description="Название базы знаний")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateKnowledgebase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateKnowledgebase:
        """Create an instance of UpdateKnowledgebase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateKnowledgebase.parse_obj(obj)

        _obj = UpdateKnowledgebase.parse_obj({
            "name": obj.get("name"),
