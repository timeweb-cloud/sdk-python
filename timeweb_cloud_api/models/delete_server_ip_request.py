...
class DeleteServerIPRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteServerIPRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteServerIPRequest:
        """Create an instance of DeleteServerIPRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteServerIPRequest.parse_obj(obj)

        _obj = DeleteServerIPRequest.parse_obj({
            "ip": obj.get("ip")
        })
        return _obj
