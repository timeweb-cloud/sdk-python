...
class NodeGroupIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeGroupIn:
    ...
    def to_dict(self):
        ...
        # set to None if is_autoscaling (nullable) is None
        # and __fields_set__ contains the field
        if self.is_autoscaling is None and "is_autoscaling" in self.__fields_set__:
            _dict['is_autoscaling'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeGroupIn:
        """Create an instance of NodeGroupIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeGroupIn.parse_obj(obj)

        _obj = NodeGroupIn.parse_obj({
            "name": obj.get("name"),
            "preset_id": obj.get("preset_id"),
            "configuration": NodeGroupInConfiguration.from_dict(obj.get("configuration")) if obj.get("configuration") is not None else None,
