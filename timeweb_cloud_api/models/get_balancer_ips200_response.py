...
class GetBalancerIPs200Response(BaseModel):
    """
    GetBalancerIPs200Response
    """
    meta: Meta = Field(...)
    ips: Optional[Any] = Field(...)
    __properties = ["meta", "ips"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBalancerIPs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBalancerIPs200Response:
        """Create an instance of GetBalancerIPs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBalancerIPs200Response.parse_obj(obj)

        _obj = GetBalancerIPs200Response.parse_obj({
