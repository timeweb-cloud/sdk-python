...
class AddStorageSubdomains200Response(BaseModel):
    """
    AddStorageSubdomains200Response
    """
    subdomains: Optional[Any] = Field(...)
    meta: Meta = Field(...)
    __properties = ["subdomains", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddStorageSubdomains200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddStorageSubdomains200Response:
        """Create an instance of AddStorageSubdomains200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddStorageSubdomains200Response.parse_obj(obj)

        _obj = AddStorageSubdomains200Response.parse_obj({
