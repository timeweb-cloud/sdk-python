...
class ClusterResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterResponse:
        """Create an instance of ClusterResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterResponse.parse_obj(obj)

        _obj = ClusterResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "cluster": ClusterOut.from_dict(obj.get("cluster")) if obj.get("cluster") is not None else None
        })
        return _obj
