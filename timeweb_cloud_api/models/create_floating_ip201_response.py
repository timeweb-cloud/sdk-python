...
class CreateFloatingIp201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFloatingIp201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFloatingIp201Response:
        """Create an instance of CreateFloatingIp201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFloatingIp201Response.parse_obj(obj)

        _obj = CreateFloatingIp201Response.parse_obj({
            "ip": FloatingIp.from_dict(obj.get("ip")) if obj.get("ip") is not None else None
        })
        return _obj
