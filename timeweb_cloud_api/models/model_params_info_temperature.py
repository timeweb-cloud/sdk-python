...
class ModelParamsInfoTemperature(BaseModel):
    """
    ...
    __properties = ["type", "min", "max", "default", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelParamsInfoTemperature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelParamsInfoTemperature:
        """Create an instance of ModelParamsInfoTemperature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelParamsInfoTemperature.parse_obj(obj)

        _obj = ModelParamsInfoTemperature.parse_obj({
            "type": obj.get("type"),
            "min": obj.get("min"),
            "max": obj.get("max"),
