...
class CreateDns(BaseModel):
    """
    CreateDns
    """
    priority: Optional[Any] = Field(None, description="Приоритет DNS-записи.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDns:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDns:
        """Create an instance of CreateDns from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDns.parse_obj(obj)

        _obj = CreateDns.parse_obj({
