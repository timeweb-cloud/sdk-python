...
class CreateKeyRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateKeyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateKeyRequest:
        """Create an instance of CreateKeyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateKeyRequest.parse_obj(obj)

        _obj = CreateKeyRequest.parse_obj({
            "body": obj.get("body"),
