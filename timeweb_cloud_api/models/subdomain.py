...
class Subdomain(BaseModel):
    ...
    Subdomain
    """
    fqdn: Optional[Any] = Field(..., description="Полное имя поддомена.")
    id: Optional[Any] = Field(..., description="Уникальный идентификатор поддомена.")
    linked_ip: Optional[Any] = Field(..., description="Привязанный к поддомену IP-адрес.")
    __properties = ["fqdn", "id", "linked_ip"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Subdomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Subdomain:
        """Create an instance of Subdomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Subdomain.parse_obj(obj)

        _obj = Subdomain.parse_obj({
            "fqdn": obj.get("fqdn"),
            "id": obj.get("id"),
