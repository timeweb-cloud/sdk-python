...
class AddServerToProjectRequest(BaseModel):
    """
    AddServerToProjectRequest
    """
    resource_id: Optional[Any] = Field(..., description="Идентификатор добавляемого сервера.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddServerToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddServerToProjectRequest:
        """Create an instance of AddServerToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddServerToProjectRequest.parse_obj(obj)

        _obj = AddServerToProjectRequest.parse_obj({
