...
class Domain(BaseModel):
    ...
    id: Optional[Any] = Field(..., description="Уникальный идентификатор домена.")
    ...
    person_id: Optional[Any] = Field(..., description="Идентификатор администратора, на которого зарегистрирован домен.")
    premium_prolong_cost: Optional[Any] = Field(..., description="Стоимость премиального домена.")
    provider: Optional[Any] = Field(..., description="Идентификатор регистратора домена.")
    ...
    tld_id: Optional[Any] = Field(..., description="Идентификатор доменной зоны.")
