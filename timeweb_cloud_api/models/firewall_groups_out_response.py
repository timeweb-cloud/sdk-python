...
class FirewallGroupsOutResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallGroupsOutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallGroupsOutResponse:
        """Create an instance of FirewallGroupsOutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallGroupsOutResponse.parse_obj(obj)

        _obj = FirewallGroupsOutResponse.parse_obj({
