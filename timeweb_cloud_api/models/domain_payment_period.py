...
class DomainPaymentPeriod(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainPaymentPeriod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainPaymentPeriod:
        """Create an instance of DomainPaymentPeriod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DomainPaymentPeriod.parse_obj(obj)

        _obj = DomainPaymentPeriod.parse_obj({
        })
        return _obj
