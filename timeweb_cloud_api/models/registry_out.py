...
class RegistryOut(BaseModel):
    ...
    RegistryOut
    """
    id: Optional[Any] = Field(..., description="ID реестра")
    name: Optional[Any] = Field(..., description="Название реестра")
    description: Optional[Any] = Field(..., description="Описание")
    preset_id: Optional[Any] = Field(..., description="ID тарифа")
    configurator_id: Optional[Any] = Field(..., description="ID конфигуратора")
    project_id: Optional[Any] = Field(..., description="ID проекта")
    created_at: Optional[Any] = Field(..., description="Дата и время создания реестра в формате ISO8601")
    updated_at: Optional[Any] = Field(..., description="Дата и время обновления реестра в формате ISO8601")
    disk_stats: RegistryOutDiskStats = Field(...)
    __properties = ["id", "name", "description", "preset_id", "configurator_id", "project_id", "created_at", "updated_at", "disk_stats"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegistryOut:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegistryOut:
        """Create an instance of RegistryOut from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegistryOut.parse_obj(obj)

        _obj = RegistryOut.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "disk_stats": RegistryOutDiskStats.from_dict(obj.get("disk_stats")) if obj.get("disk_stats") is not None else None
        })
        return _obj
