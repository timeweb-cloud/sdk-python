...
class FirewallGroupResourcesOutResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallGroupResourcesOutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallGroupResourcesOutResponse:
        """Create an instance of FirewallGroupResourcesOutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallGroupResourcesOutResponse.parse_obj(obj)

        _obj = FirewallGroupResourcesOutResponse.parse_obj({
