...
class ImageUpdateAPI(BaseModel):
    """
    ImageUpdateAPI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageUpdateAPI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageUpdateAPI:
        """Create an instance of ImageUpdateAPI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageUpdateAPI.parse_obj(obj)

        _obj = ImageUpdateAPI.parse_obj({
            "name": obj.get("name"),
