...
class FirewallRuleInAPI(BaseModel):
    """
    FirewallRuleInAPI
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallRuleInAPI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallRuleInAPI:
        """Create an instance of FirewallRuleInAPI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallRuleInAPI.parse_obj(obj)

        _obj = FirewallRuleInAPI.parse_obj({
