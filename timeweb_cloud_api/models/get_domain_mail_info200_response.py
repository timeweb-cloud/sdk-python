...
class GetDomainMailInfo200Response(BaseModel):
    """
    GetDomainMailInfo200Response
    """
    domain_info: DomainInfo = Field(...)
    __properties = ["domain_info"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDomainMailInfo200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDomainMailInfo200Response:
        """Create an instance of GetDomainMailInfo200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDomainMailInfo200Response.parse_obj(obj)

        _obj = GetDomainMailInfo200Response.parse_obj({
            "domain_info": DomainInfo.from_dict(obj.get("domain_info")) if obj.get("domain_info") is not None else None
        })
        return _obj
