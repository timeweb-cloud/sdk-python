...
class UploadSuccessfulResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UploadSuccessfulResponse:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of upload_successful
        if self.upload_successful:
            _dict['upload_successful'] = self.upload_successful.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UploadSuccessfulResponse:
        """Create an instance of UploadSuccessfulResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UploadSuccessfulResponse.parse_obj(obj)

        _obj = UploadSuccessfulResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "upload_successful": UploadSuccessful.from_dict(obj.get("upload_successful")) if obj.get("upload_successful") is not None else None
        })
        return _obj
