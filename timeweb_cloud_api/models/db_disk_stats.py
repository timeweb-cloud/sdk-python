...
class DbDiskStats(BaseModel):
    ...
    """
    size: Optional[Any] = Field(..., description="Размер (в Кб) диска базы данных.")
    used: Optional[Any] = Field(..., description="Размер (в Кб) использованного пространства диска базы данных.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DbDiskStats:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DbDiskStats:
        """Create an instance of DbDiskStats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DbDiskStats.parse_obj(obj)

        _obj = DbDiskStats.parse_obj({
            "size": obj.get("size"),
            "used": obj.get("used")
        })
        return _obj
