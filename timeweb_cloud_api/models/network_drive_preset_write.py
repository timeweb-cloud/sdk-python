...
class NetworkDrivePresetWrite(BaseModel):
    """
    NetworkDrivePresetWrite
    """
    min: Optional[Any] = Field(None, description="Запись IOPS")
    max: Optional[Any] = Field(None, description="Запись IOPS")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDrivePresetWrite:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDrivePresetWrite:
        """Create an instance of NetworkDrivePresetWrite from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDrivePresetWrite.parse_obj(obj)

        _obj = NetworkDrivePresetWrite.parse_obj({
            "min": obj.get("min"),
            "max": obj.get("max")
        })
        return _obj
