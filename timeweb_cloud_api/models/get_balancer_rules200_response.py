...
class GetBalancerRules200Response(BaseModel):
    """
    GetBalancerRules200Response
    """
    meta: Meta = Field(...)
    rules: Optional[Any] = Field(...)
    __properties = ["meta", "rules"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetBalancerRules200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetBalancerRules200Response:
        """Create an instance of GetBalancerRules200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetBalancerRules200Response.parse_obj(obj)

        _obj = GetBalancerRules200Response.parse_obj({
