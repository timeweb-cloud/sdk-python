...
class AddonsResponse(BaseModel):
    ...
    addons: Optional[Any] = Field(..., description="Массив дополнений k8s")
    __properties = ["response_id", "meta", "addons"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddonsResponse:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.addons is None and "addons" in self.__fields_set__:
            _dict['addons'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AddonsResponse:
        """Create an instance of AddonsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddonsResponse.parse_obj(obj)

        _obj = AddonsResponse.parse_obj({
