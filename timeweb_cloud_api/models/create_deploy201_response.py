...
class CreateDeploy201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDeploy201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDeploy201Response:
        """Create an instance of CreateDeploy201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDeploy201Response.parse_obj(obj)

        _obj = CreateDeploy201Response.parse_obj({
