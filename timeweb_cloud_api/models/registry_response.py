...
class RegistryResponse(BaseModel):
    ...
    container_registry: RegistryOut = Field(...)
    __properties = ["response_id", "container_registry"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegistryResponse:
    ...
    def to_dict(self):
        ...
        if self.container_registry:
            _dict['container_registry'] = self.container_registry.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegistryResponse:
        """Create an instance of RegistryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegistryResponse.parse_obj(obj)

        _obj = RegistryResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "container_registry": RegistryOut.from_dict(obj.get("container_registry")) if obj.get("container_registry") is not None else None
        })
        return _obj
