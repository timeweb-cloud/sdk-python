...
class MountNetworkDrive(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MountNetworkDrive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MountNetworkDrive:
        """Create an instance of MountNetworkDrive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MountNetworkDrive.parse_obj(obj)

        _obj = MountNetworkDrive.parse_obj({
