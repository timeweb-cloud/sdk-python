...
class CreateServer201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateServer201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateServer201Response:
        """Create an instance of CreateServer201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateServer201Response.parse_obj(obj)

        _obj = CreateServer201Response.parse_obj({
            "server": Vds.from_dict(obj.get("server")) if obj.get("server") is not None else None
        })
        return _obj
