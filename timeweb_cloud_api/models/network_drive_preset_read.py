...
class NetworkDrivePresetRead(BaseModel):
    """
    NetworkDrivePresetRead
    """
    min: Optional[Any] = Field(None, description="Чтение IOPS")
    max: Optional[Any] = Field(None, description="Чтение IOPS")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDrivePresetRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDrivePresetRead:
        """Create an instance of NetworkDrivePresetRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDrivePresetRead.parse_obj(obj)

        _obj = NetworkDrivePresetRead.parse_obj({
            "min": obj.get("min"),
            "max": obj.get("max")
        })
        return _obj
