...
class ResourceTransfer(BaseModel):
    ...
    def resource_type_validate_enum(cls, value):
        ...
        if value not in ('server', 'balancer', 'database', 'kubernetes', 'storage', 'dedicated'):
            raise ValueError("must be one of enum values ('server', 'balancer', 'database', 'kubernetes', 'storage', 'dedicated')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceTransfer:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # set to None if to_project (nullable) is None
        # and __fields_set__ contains the field
        if self.to_project is None and "to_project" in self.__fields_set__:
            _dict['to_project'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceTransfer:
        """Create an instance of ResourceTransfer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceTransfer.parse_obj(obj)

        _obj = ResourceTransfer.parse_obj({
            "to_project": obj.get("to_project"),
