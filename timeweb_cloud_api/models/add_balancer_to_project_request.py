...
class AddBalancerToProjectRequest(BaseModel):
    """
    AddBalancerToProjectRequest
    """
    resource_id: Optional[Any] = Field(..., description="Идентификатор добавляемого балансировщика.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddBalancerToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddBalancerToProjectRequest:
        """Create an instance of AddBalancerToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddBalancerToProjectRequest.parse_obj(obj)

        _obj = AddBalancerToProjectRequest.parse_obj({
