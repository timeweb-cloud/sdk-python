...
class ImageUrlIn(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageUrlIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageUrlIn:
        """Create an instance of ImageUrlIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageUrlIn.parse_obj(obj)

        _obj = ImageUrlIn.parse_obj({
            "type": obj.get("type"),
            "filename": obj.get("filename"),
            "auth": ImageUrlAuth.from_dict(obj.get("auth")) if obj.get("auth") is not None else None
        })
        return _obj
