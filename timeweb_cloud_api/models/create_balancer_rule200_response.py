...
class CreateBalancerRule200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBalancerRule200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBalancerRule200Response:
        """Create an instance of CreateBalancerRule200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBalancerRule200Response.parse_obj(obj)

        _obj = CreateBalancerRule200Response.parse_obj({
            "rule": Rule.from_dict(obj.get("rule")) if obj.get("rule") is not None else None
        })
        return _obj
