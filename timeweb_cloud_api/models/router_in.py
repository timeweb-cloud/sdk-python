...
class RouterIn(BaseModel):
    ...
    comment: Optional[Any] = Field(None, description="Описание роутера")
    preset_id: Optional[Any] = Field(..., description="ID тарифа")
    project_id: Optional[Any] = Field(None, description="ID проекта")
    networks: Optional[Any] = Field(..., description="Подключаемые сети")
    ips: Optional[Any] = Field(None, description="IP-адреса")
    parent_service: Optional[RouterInParentService] = None
    __properties = ["name", "comment", "preset_id", "project_id", "networks", "ips", "parent_service"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RouterIn:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of parent_service
        if self.parent_service:
            _dict['parent_service'] = self.parent_service.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RouterIn:
        """Create an instance of RouterIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RouterIn.parse_obj(obj)

        _obj = RouterIn.parse_obj({
            "name": obj.get("name"),
            ...
            "ips": obj.get("ips"),
            "parent_service": RouterInParentService.from_dict(obj.get("parent_service")) if obj.get("parent_service") is not None else None
        })
        return _obj
