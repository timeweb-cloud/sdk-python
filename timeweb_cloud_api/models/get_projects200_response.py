...
class GetProjects200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetProjects200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetProjects200Response:
        """Create an instance of GetProjects200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetProjects200Response.parse_obj(obj)

        _obj = GetProjects200Response.parse_obj({
