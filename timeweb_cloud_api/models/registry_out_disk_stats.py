...
class RegistryOutDiskStats(BaseModel):
    """
    Конфигурация диска
    """
    size: Optional[Any] = Field(..., description="Размер диска")
    used: Optional[Any] = Field(..., description="Используемый размер")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegistryOutDiskStats:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegistryOutDiskStats:
        """Create an instance of RegistryOutDiskStats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegistryOutDiskStats.parse_obj(obj)

        _obj = RegistryOutDiskStats.parse_obj({
            "size": obj.get("size"),
            "used": obj.get("used")
        })
        return _obj
