...
class DeleteCountriesFromAllowedListRequest(BaseModel):
    """
    DeleteCountriesFromAllowedListRequest
    """
    countries: Optional[Any] = Field(..., description="Список удаляемых из списка разрешенных стран.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteCountriesFromAllowedListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteCountriesFromAllowedListRequest:
        """Create an instance of DeleteCountriesFromAllowedListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteCountriesFromAllowedListRequest.parse_obj(obj)

        _obj = DeleteCountriesFromAllowedListRequest.parse_obj({
