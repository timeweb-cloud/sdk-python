...
class GetProjectClusters200Response(BaseModel):
    """
    GetProjectClusters200Response
    """
    clusters: Optional[Any] = Field(...)
    meta: Meta = Field(...)
    __properties = ["clusters", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetProjectClusters200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetProjectClusters200Response:
        """Create an instance of GetProjectClusters200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetProjectClusters200Response.parse_obj(obj)

        _obj = GetProjectClusters200Response.parse_obj({
