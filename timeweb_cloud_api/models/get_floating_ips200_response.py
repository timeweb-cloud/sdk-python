...
class GetFloatingIps200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFloatingIps200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFloatingIps200Response:
        """Create an instance of GetFloatingIps200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFloatingIps200Response.parse_obj(obj)

        _obj = GetFloatingIps200Response.parse_obj({
