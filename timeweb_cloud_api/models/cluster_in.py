...
class ClusterIn(BaseModel):
    ...
    ClusterIn
    """
    name: Optional[Any] = Field(..., description="Название кластера")
    description: Optional[Any] = Field(None, description="Описание кластера")
    ...
    def network_driver_validate_enum(cls, value):
        ...
        if value not in ('kuberouter', 'calico', 'flannel', 'cilium'):
            raise ValueError("must be one of enum values ('kuberouter', 'calico', 'flannel', 'cilium')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterIn:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.availability_zone is None and "availability_zone" in self.__fields_set__:
            _dict['availability_zone'] = None
        ...
        # set to None if is_ingress (nullable) is None
        # and __fields_set__ contains the field
        if self.is_ingress is None and "is_ingress" in self.__fields_set__:
            _dict['is_ingress'] = None

        # set to None if is_k8s_dashboard (nullable) is None
        # and __fields_set__ contains the field
        if self.is_k8s_dashboard is None and "is_k8s_dashboard" in self.__fields_set__:
            _dict['is_k8s_dashboard'] = None
        ...
        if self.worker_groups is None and "worker_groups" in self.__fields_set__:
            _dict['worker_groups'] = None

        # set to None if network_id (nullable) is None
        # and __fields_set__ contains the field
        if self.network_id is None and "network_id" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterIn:
        """Create an instance of ClusterIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterIn.parse_obj(obj)

        _obj = ClusterIn.parse_obj({
            "name": obj.get("name"),
