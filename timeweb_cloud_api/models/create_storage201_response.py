...
class CreateStorage201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateStorage201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateStorage201Response:
        """Create an instance of CreateStorage201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateStorage201Response.parse_obj(obj)

        _obj = CreateStorage201Response.parse_obj({
