...
class GetProjectDatabases200Response(BaseModel):
    """
    GetProjectDatabases200Response
    """
    databases: Optional[Any] = Field(...)
    meta: Meta = Field(...)
    __properties = ["databases", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetProjectDatabases200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetProjectDatabases200Response:
        """Create an instance of GetProjectDatabases200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetProjectDatabases200Response.parse_obj(obj)

        _obj = GetProjectDatabases200Response.parse_obj({
