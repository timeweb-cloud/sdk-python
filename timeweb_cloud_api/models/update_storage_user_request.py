...
class UpdateStorageUserRequest(BaseModel):
    """
    UpdateStorageUserRequest
    """
    secret_key: Optional[Any] = Field(..., description="Новый пароль пользователя-администратора хранилища.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateStorageUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateStorageUserRequest:
        """Create an instance of UpdateStorageUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateStorageUserRequest.parse_obj(obj)

        _obj = UpdateStorageUserRequest.parse_obj({
