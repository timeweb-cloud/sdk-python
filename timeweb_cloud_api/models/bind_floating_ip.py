...
class BindFloatingIp(BaseModel):
    """
    BindFloatingIp
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BindFloatingIp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BindFloatingIp:
        """Create an instance of BindFloatingIp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BindFloatingIp.parse_obj(obj)

        _obj = BindFloatingIp.parse_obj({
