...
class ServicePriceConfiguration(BaseModel):
    """
    ...
    disk: Optional[Any] = Field(None, description="Объем дискового пространства в ГБ")
    __properties = ["cpu", "ram", "disk"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServicePriceConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServicePriceConfiguration:
        """Create an instance of ServicePriceConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServicePriceConfiguration.parse_obj(obj)

        _obj = ServicePriceConfiguration.parse_obj({
            "cpu": obj.get("cpu"),
            "ram": obj.get("ram"),
            "disk": obj.get("disk")
        })
