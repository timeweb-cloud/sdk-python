...
class Provider(BaseModel):
    ...
    Provider
    """
    provider_id: Optional[Any] = Field(..., description="Идентификатор провайдера.")
    login: Optional[Any] = Field(..., description="Логин пользователя.")
    provider_type: Providers = Field(...)
    __properties = ["provider_id", "login", "provider_type"]
