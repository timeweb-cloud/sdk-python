...
class OutgoingIsDisabled(BaseModel):
    """
    OutgoingIsDisabled
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutgoingIsDisabled:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutgoingIsDisabled:
        """Create an instance of OutgoingIsDisabled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutgoingIsDisabled.parse_obj(obj)

        _obj = OutgoingIsDisabled.parse_obj({
