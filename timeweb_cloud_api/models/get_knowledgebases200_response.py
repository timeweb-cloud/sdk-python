...
class GetKnowledgebases200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetKnowledgebases200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetKnowledgebases200Response:
        """Create an instance of GetKnowledgebases200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetKnowledgebases200Response.parse_obj(obj)
