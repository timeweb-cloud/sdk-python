...
class ClusterInConfiguration(BaseModel):
    """
    Параметры конфигурации мастер-ноды. Нельзя передавать вместе с `preset_id`.
    """
    configurator_id: Optional[Any] = Field(..., description="ID конфигуратора мастер-ноды")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterInConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterInConfiguration:
        """Create an instance of ClusterInConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterInConfiguration.parse_obj(obj)

        _obj = ClusterInConfiguration.parse_obj({
