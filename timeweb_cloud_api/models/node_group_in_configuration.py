...
class NodeGroupInConfiguration(BaseModel):
    """
    ...
    """
    configurator_id: Optional[Any] = Field(..., description="ID конфигуратора кластера")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeGroupInConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeGroupInConfiguration:
        """Create an instance of NodeGroupInConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeGroupInConfiguration.parse_obj(obj)

        _obj = NodeGroupInConfiguration.parse_obj({
