...
class AppConfiguration(BaseModel):
    ...
    network_bandwidth: Optional[Any] = Field(None, description="Скорость сетевого канала (в Мбит/с).")
    cpu_frequency: Optional[Any] = Field(None, description="Частота процессора (в ГГц).")
    disk_type: Optional[Any] = Field(None, description="Тип диска.")
    __properties = ["cpu", "ram", "network_bandwidth", "cpu_frequency", "disk_type"]
    ...
    def to_dict(self):
        ...
        # set to None if network_bandwidth (nullable) is None
        # and __fields_set__ contains the field
        if self.network_bandwidth is None and "network_bandwidth" in self.__fields_set__:
            _dict['network_bandwidth'] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppConfiguration:
        """Create an instance of AppConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppConfiguration.parse_obj(obj)

        _obj = AppConfiguration.parse_obj({
            "cpu": obj.get("cpu"),
            "ram": obj.get("ram"),
            "network_bandwidth": obj.get("network_bandwidth"),
