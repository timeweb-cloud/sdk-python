...
class Project(BaseModel):
    ...
    Проект
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор для каждого проекта. Автоматически генерируется при создании.")
    account_id: Optional[Any] = Field(..., description="Идентификатор пользователя.")
    avatar_id: Optional[Any] = Field(..., description="Идентификатор аватара пользователя. Описание методов работы с аватарами появится позднее.")
