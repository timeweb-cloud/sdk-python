...
class UpdateKeyRequest(BaseModel):
    ...
    UpdateKeyRequest
    """
    body: Optional[Any] = Field(None, description="Тело SSH-ключа")
    is_default: Optional[Any] = Field(None, description="Будет ли выбираться SSH-ключ по умолчанию при создании сервера")
    name: Optional[Any] = Field(None, description="Название SSH-ключа")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateKeyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateKeyRequest:
        """Create an instance of UpdateKeyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateKeyRequest.parse_obj(obj)

        _obj = UpdateKeyRequest.parse_obj({
            "body": obj.get("body"),
