...
class RouterStatisticsResponse(BaseModel):
    ...
    statistics: Optional[Any] = Field(..., description="Статистика")
    __properties = ["response_id", "statistics"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RouterStatisticsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RouterStatisticsResponse:
        """Create an instance of RouterStatisticsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RouterStatisticsResponse.parse_obj(obj)

        _obj = RouterStatisticsResponse.parse_obj({
