...
class GetDomain200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetDomain200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetDomain200Response:
        """Create an instance of GetDomain200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetDomain200Response.parse_obj(obj)

        _obj = GetDomain200Response.parse_obj({
