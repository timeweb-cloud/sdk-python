...
class AvailabilityZone(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailabilityZone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailabilityZone:
        """Create an instance of AvailabilityZone from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailabilityZone.parse_obj(obj)

        _obj = AvailabilityZone.parse_obj({
        })
        return _obj
