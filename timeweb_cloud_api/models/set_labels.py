...
class SetLabels(BaseModel):
    ...
    """
    key: Optional[Any] = Field(..., description="Ключ")
    value: Optional[Any] = Field(..., description="Значение")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetLabels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetLabels:
        """Create an instance of SetLabels from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SetLabels.parse_obj(obj)

        _obj = SetLabels.parse_obj({
            "key": obj.get("key"),
            "value": obj.get("value")
        })
        return _obj
