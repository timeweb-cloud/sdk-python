...
class CreateDedicatedServer(BaseModel):
    ...
    bandwidth_id: Optional[Any] = Field(None, description="ID интернет-канала, который будет установлен на выделенный сервер.")
    network_drive_id: Optional[Any] = Field(None, description="ID сетевого диска, который будет установлен на выделенный сервер.")
    additional_ip_addr_id: Optional[Any] = Field(None, description="ID дополнительного IP-адреса, который будет установлен на выделенный сервер.")
