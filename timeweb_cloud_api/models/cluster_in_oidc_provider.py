...
class ClusterInOidcProvider(BaseModel):
    """
    OIDC-провайдер
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterInOidcProvider:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterInOidcProvider:
        """Create an instance of ClusterInOidcProvider from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterInOidcProvider.parse_obj(obj)

        _obj = ClusterInOidcProvider.parse_obj({
            "name": obj.get("name"),
