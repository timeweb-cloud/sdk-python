...
class K8SVersionsResponse(BaseModel):
    """
    K8SVersionsResponse
    """
    response_id: Optional[Any] = Field(None, description="Идентификатор запроса")
    meta: Meta = Field(...)
    k8s_versions: Optional[Any] = Field(..., description="Массив версий k8s")
    __properties = ["response_id", "meta", "k8s_versions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> K8SVersionsResponse:
    ...
    def to_dict(self):
        ...
        # set to None if k8s_versions (nullable) is None
        # and __fields_set__ contains the field
        if self.k8s_versions is None and "k8s_versions" in self.__fields_set__:
            _dict['k8s_versions'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> K8SVersionsResponse:
        """Create an instance of K8SVersionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return K8SVersionsResponse.parse_obj(obj)

        _obj = K8SVersionsResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "k8s_versions": obj.get("k8s_versions")
        })
        return _obj
