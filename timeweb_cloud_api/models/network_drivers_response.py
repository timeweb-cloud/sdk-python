...
class NetworkDriversResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkDriversResponse:
    ...
    def to_dict(self):
        ...
        # set to None if network_drivers (nullable) is None
        # and __fields_set__ contains the field
        if self.network_drivers is None and "network_drivers" in self.__fields_set__:
            _dict['network_drivers'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> NetworkDriversResponse:
        """Create an instance of NetworkDriversResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkDriversResponse.parse_obj(obj)
