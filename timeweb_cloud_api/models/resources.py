...
class Resources(BaseModel):
    ...
    Resources
    """
    nodes: Optional[Any] = Field(None, description="Количество нод")
    cores: Optional[Resource] = None
    memory: Optional[Resource] = None
    pods: Optional[Resource] = None
    __properties = ["nodes", "cores", "memory", "pods"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Resources:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Resources:
        """Create an instance of Resources from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Resources.parse_obj(obj)

        _obj = Resources.parse_obj({
            "nodes": obj.get("nodes"),
            "cores": Resource.from_dict(obj.get("cores")) if obj.get("cores") is not None else None,
            "memory": Resource.from_dict(obj.get("memory")) if obj.get("memory") is not None else None,
            "pods": Resource.from_dict(obj.get("pods")) if obj.get("pods") is not None else None
        })
        return _obj
