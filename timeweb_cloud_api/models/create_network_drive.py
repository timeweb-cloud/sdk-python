...
class CreateNetworkDrive(BaseModel):
    """
    CreateNetworkDrive
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNetworkDrive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNetworkDrive:
        """Create an instance of CreateNetworkDrive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNetworkDrive.parse_obj(obj)

        _obj = CreateNetworkDrive.parse_obj({
            "name": obj.get("name"),
