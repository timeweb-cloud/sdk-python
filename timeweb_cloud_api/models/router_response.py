...
class RouterResponse(BaseModel):
    ...
    router: RouterOut = Field(...)
    __properties = ["response_id", "router"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RouterResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RouterResponse:
        """Create an instance of RouterResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RouterResponse.parse_obj(obj)

        _obj = RouterResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "router": RouterOut.from_dict(obj.get("router")) if obj.get("router") is not None else None
        })
        return _obj
