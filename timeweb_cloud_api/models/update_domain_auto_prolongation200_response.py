...
class UpdateDomainAutoProlongation200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDomainAutoProlongation200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDomainAutoProlongation200Response:
        """Create an instance of UpdateDomainAutoProlongation200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDomainAutoProlongation200Response.parse_obj(obj)

        _obj = UpdateDomainAutoProlongation200Response.parse_obj({
