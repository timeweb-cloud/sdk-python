...
class DatabaseClusterDisk(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatabaseClusterDisk:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatabaseClusterDisk:
        """Create an instance of DatabaseClusterDisk from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatabaseClusterDisk.parse_obj(obj)

        _obj = DatabaseClusterDisk.parse_obj({
            "size": obj.get("size"),
            "used": obj.get("used")
        })
        return _obj
