...
class CreateDatabaseUser201Response(BaseModel):
    """
    CreateDatabaseUser201Response
    """
    admin: DatabaseAdmin = Field(...)
    __properties = ["admin"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDatabaseUser201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDatabaseUser201Response:
        """Create an instance of CreateDatabaseUser201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDatabaseUser201Response.parse_obj(obj)

        _obj = CreateDatabaseUser201Response.parse_obj({
            "admin": DatabaseAdmin.from_dict(obj.get("admin")) if obj.get("admin") is not None else None
        })
        return _obj
