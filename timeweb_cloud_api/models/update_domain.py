...
class UpdateDomain(BaseModel):
    ...
    linked_ip: Optional[Any] = Field(None, description="Привязанный к домену IP-адрес.")
    __properties = ["is_autoprolong_enabled", "linked_ip"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDomain:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDomain:
        """Create an instance of UpdateDomain from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDomain.parse_obj(obj)

        _obj = UpdateDomain.parse_obj({
