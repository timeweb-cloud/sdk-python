...
class NetworkResponse(BaseModel):
    ...
    router_network: NetworkOut = Field(...)
    __properties = ["response_id", "router_network"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkResponse:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of router_network
        if self.router_network:
            _dict['router_network'] = self.router_network.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkResponse:
        """Create an instance of NetworkResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkResponse.parse_obj(obj)

        _obj = NetworkResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "router_network": NetworkOut.from_dict(obj.get("router_network")) if obj.get("router_network") is not None else None
        })
        return _obj
