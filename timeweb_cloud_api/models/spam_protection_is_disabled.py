...
class SpamProtectionIsDisabled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpamProtectionIsDisabled:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpamProtectionIsDisabled:
        """Create an instance of SpamProtectionIsDisabled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpamProtectionIsDisabled.parse_obj(obj)

        _obj = SpamProtectionIsDisabled.parse_obj({
