...
class CreateFloatingIp(BaseModel):
    """
    CreateFloatingIp
    """
    ...
    __properties = ["is_ddos_guard", "availability_zone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateFloatingIp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFloatingIp:
        """Create an instance of CreateFloatingIp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFloatingIp.parse_obj(obj)

        _obj = CreateFloatingIp.parse_obj({
