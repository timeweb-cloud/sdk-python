...
class CreateDeployRequest(BaseModel):
    """
    CreateDeployRequest
    """
    commit_sha: Optional[Any] = Field(None, description="Хэш коммита.")
    __properties = ["commit_sha"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDeployRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDeployRequest:
        """Create an instance of CreateDeployRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDeployRequest.parse_obj(obj)

        _obj = CreateDeployRequest.parse_obj({
