...
class AddDedicatedServerToProjectRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddDedicatedServerToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddDedicatedServerToProjectRequest:
        """Create an instance of AddDedicatedServerToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddDedicatedServerToProjectRequest.parse_obj(obj)

        _obj = AddDedicatedServerToProjectRequest.parse_obj({
