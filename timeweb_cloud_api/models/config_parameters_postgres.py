...
class ConfigParametersPostgres(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigParametersPostgres:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigParametersPostgres:
        """Create an instance of ConfigParametersPostgres from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigParametersPostgres.parse_obj(obj)

        _obj = ConfigParametersPostgres.parse_obj({
