...
class GetTokens200Response(BaseModel):
    """
    GetTokens200Response
    """
    meta: Meta = Field(...)
    api_keys: Optional[Any] = Field(...)
    __properties = ["meta", "api_keys"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTokens200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTokens200Response:
        """Create an instance of GetTokens200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTokens200Response.parse_obj(obj)

        _obj = GetTokens200Response.parse_obj({
