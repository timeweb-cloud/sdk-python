...
class AddCountriesToAllowedListRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddCountriesToAllowedListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddCountriesToAllowedListRequest:
        """Create an instance of AddCountriesToAllowedListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddCountriesToAllowedListRequest.parse_obj(obj)

        _obj = AddCountriesToAllowedListRequest.parse_obj({
