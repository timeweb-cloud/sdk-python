...
class ReduceNodes(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReduceNodes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReduceNodes:
        """Create an instance of ReduceNodes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReduceNodes.parse_obj(obj)

        _obj = ReduceNodes.parse_obj({
            "count": obj.get("count")
        })
        return _obj
