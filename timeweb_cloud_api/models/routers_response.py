...
class RoutersResponse(BaseModel):
    ...
    routers: Optional[Any] = Field(..., description="Роутеры")
    meta: ComponentsSchemasMeta = Field(...)
    __properties = ["response_id", "routers", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoutersResponse:
    ...
    def to_dict(self):
        ...
        # set to None if routers (nullable) is None
        # and __fields_set__ contains the field
        if self.routers is None and "routers" in self.__fields_set__:
            _dict['routers'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> RoutersResponse:
        """Create an instance of RoutersResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoutersResponse.parse_obj(obj)

        _obj = RoutersResponse.parse_obj({
