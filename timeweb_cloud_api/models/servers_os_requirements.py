...
class ServersOsRequirements(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServersOsRequirements:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServersOsRequirements:
        """Create an instance of ServersOsRequirements from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServersOsRequirements.parse_obj(obj)

        _obj = ServersOsRequirements.parse_obj({
