...
class DnatIn(BaseModel):
    """
    DnatIn
    """
    protocol: Optional[Any] = Field(..., description="Протокол")
    local: DnatInLocal = Field(...)
    public: DnatInPublic = Field(...)
    __properties = ["protocol", "local", "public"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnatIn:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DnatIn:
        """Create an instance of DnatIn from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnatIn.parse_obj(obj)

        _obj = DnatIn.parse_obj({
            "protocol": obj.get("protocol"),
            "local": DnatInLocal.from_dict(obj.get("local")) if obj.get("local") is not None else None,
            "public": DnatInPublic.from_dict(obj.get("public")) if obj.get("public") is not None else None
        })
        return _obj
