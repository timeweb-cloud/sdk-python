...
class MailboxesBatchV2(BaseModel):
    """
    Результат массового создания почтовых ящиков (API v2)
    """
    mailboxes: Optional[Any] = Field(..., description="Массив успешно созданных почтовых ящиков")
    errors: Optional[Any] = Field(..., description="Массив ошибок при создании почтовых ящиков")
    __properties = ["mailboxes", "errors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MailboxesBatchV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MailboxesBatchV2:
        """Create an instance of MailboxesBatchV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MailboxesBatchV2.parse_obj(obj)

        _obj = MailboxesBatchV2.parse_obj({
