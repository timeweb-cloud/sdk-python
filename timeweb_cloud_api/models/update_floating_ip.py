...
class UpdateFloatingIp(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateFloatingIp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateFloatingIp:
        """Create an instance of UpdateFloatingIp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateFloatingIp.parse_obj(obj)

        _obj = UpdateFloatingIp.parse_obj({
