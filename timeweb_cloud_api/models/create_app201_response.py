...
class CreateApp201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateApp201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateApp201Response:
        """Create an instance of CreateApp201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateApp201Response.parse_obj(obj)

        _obj = CreateApp201Response.parse_obj({
