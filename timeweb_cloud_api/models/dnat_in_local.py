...
class DnatInLocal(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DnatInLocal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DnatInLocal:
        """Create an instance of DnatInLocal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DnatInLocal.parse_obj(obj)

        _obj = DnatInLocal.parse_obj({
            "ip": obj.get("ip"),
            "port": obj.get("port")
        })
        return _obj
