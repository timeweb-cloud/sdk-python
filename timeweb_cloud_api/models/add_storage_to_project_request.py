...
class AddStorageToProjectRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddStorageToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddStorageToProjectRequest:
        """Create an instance of AddStorageToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddStorageToProjectRequest.parse_obj(obj)

        _obj = AddStorageToProjectRequest.parse_obj({
