...
class FirewallGroupOutResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirewallGroupOutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirewallGroupOutResponse:
        """Create an instance of FirewallGroupOutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirewallGroupOutResponse.parse_obj(obj)
