...
from timeweb_cloud_api.configuration import Configuration
from timeweb_cloud_api.api_response import ApiResponse
import timeweb_cloud_api.models
from timeweb_cloud_api import rest
from timeweb_cloud_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(timeweb_cloud_api.models, klass)
