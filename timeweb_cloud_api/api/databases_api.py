...
class DatabasesApi(object):
    ...
    @validate_arguments
    def get_database_cluster_types(self, **kwargs) -> GetDatabaseClusterTypes200Response:  # noqa: E501
        """Получение списка типов кластеров баз данных  # noqa: E501

        Чтобы получить список типов баз данных на вашем аккаунте, отправьте GET-запрос на `/api/v1/database-types`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_database_cluster_types(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetDatabaseClusterTypes200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_database_cluster_types_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_database_cluster_types_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_database_cluster_types_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Получение списка типов кластеров баз данных  # noqa: E501
        ...
        >>> thread = api.get_database_cluster_types_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetDatabaseClusterTypes200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_database_cluster_types" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetDatabaseClusterTypes200Response",
            '400': None,
            '401': None,
            '403': None,
            '404': None,
    ...
    def get_database_parameters(self, **kwargs) -> Dict[str, object]:  # noqa: E501
        ...
        >>> thread = api.get_database_parameters(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_database_parameters_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_database_parameters_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_database_parameters_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Получение списка параметров баз данных  # noqa: E501
        ...
        >>> thread = api.get_database_parameters_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_database_parameters" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
