...
class ServersApi(object):
    ...
    def get_server_statistics(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], date_from : Annotated[Any, Field(..., description="Дата начала сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-25T14%3A35%3A38`")], date_to : Annotated[Any, Field(..., description="Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-26T14%3A35%3A38`")], **kwargs) -> GetServerStatistics200Response:  # noqa: E501
        ...
        :param date_to: Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-26T14%3A35%3A38` (required)
        :type date_to: object
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_server_statistics_with_http_info(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], date_from : Annotated[Any, Field(..., description="Дата начала сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-25T14%3A35%3A38`")], date_to : Annotated[Any, Field(..., description="Дата окончания сбора статистики. Строка в формате ISO 8061, закодированная в ASCII, пример: `2023-05-26T14%3A35%3A38`")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        warnings.warn("GET /api/v1/servers/{server_id}/statistics is deprecated.", DeprecationWarning)
    ...
    def get_server_statistics_new(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], time_from : Annotated[Any, Field(..., description="Дата начала сбора статистики.")], period : Annotated[Any, Field(..., description="Количество часов за период которых нужна статистика.")], keys : Annotated[Any, Field(..., description="Ключи выбираемых видов статистики.")], **kwargs) -> GetServerStatisticsNew200Response:  # noqa: E501
        ...
        >>> thread = api.get_server_statistics_new(server_id, time_from, period, keys, async_req=True)
        >>> result = thread.get()

        :param server_id: ID облачного сервера. (required)
        :type server_id: object
        :param time_from: Дата начала сбора статистики. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetServerStatisticsNew200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_server_statistics_new_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_server_statistics_new_with_http_info(server_id, time_from, period, keys, **kwargs)  # noqa: E501
    ...
    def get_server_statistics_new_with_http_info(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], time_from : Annotated[Any, Field(..., description="Дата начала сбора статистики.")], period : Annotated[Any, Field(..., description="Количество часов за период которых нужна статистика.")], keys : Annotated[Any, Field(..., description="Ключи выбираемых видов статистики.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_server_statistics_new_with_http_info(server_id, time_from, period, keys, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetServerStatisticsNew200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_server_statistics_new" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetServerStatisticsNew200Response",
            '400': None,
            '401': None,
            '403': None,
            '404': None,
    ...
    @validate_arguments
    def reboot_server_hard(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], **kwargs) -> None:  # noqa: E501
        """Принудительная перезагрузка сервера  # noqa: E501

        Чтобы принудительно перезагрузить сервер, отправьте POST-запрос на `/api/v1/servers/{server_id}/hard-reboot`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.reboot_server_hard(server_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the reboot_server_hard_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.reboot_server_hard_with_http_info(server_id, **kwargs)  # noqa: E501

    @validate_arguments
    def reboot_server_hard_with_http_info(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Принудительная перезагрузка сервера  # noqa: E501
        ...
        >>> thread = api.reboot_server_hard_with_http_info(server_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reboot_server_hard" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
