...
class DomainsApi(object):
    ...
    @validate_arguments
    def get_domain_request(self, request_id : Annotated[Any, Field(..., description="ID заявки на регистрацию/продление/трансфер домена.")], **kwargs) -> CreateDomainRequest201Response:  # noqa: E501
        ...
        :param request_id: ID заявки на регистрацию/продление/трансфер домена. (required)
    ...
    @validate_arguments
    def get_domain_request_with_http_info(self, request_id : Annotated[Any, Field(..., description="ID заявки на регистрацию/продление/трансфер домена.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Получение заявки на регистрацию/продление/трансфер домена  # noqa: E501
    ...
    @validate_arguments
    def get_domain_requests(self, person_id : Annotated[Optional[Any], Field(description="ID администратора, на которого зарегистрирован домен.")] = None, **kwargs) -> GetDomainRequests200Response:  # noqa: E501
        ...
        :param person_id: ID администратора, на которого зарегистрирован домен.
    ...
    @validate_arguments
    def get_domain_requests_with_http_info(self, person_id : Annotated[Optional[Any], Field(description="ID администратора, на которого зарегистрирован домен.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Получение списка заявок на регистрацию/продление/трансфер домена  # noqa: E501
    ...
    @validate_arguments
    def get_tld(self, tld_id : Annotated[Any, Field(..., description="ID доменной зоны.")], **kwargs) -> GetTLD200Response:  # noqa: E501
        """Получить информацию о доменной зоне по ID  # noqa: E501

        Чтобы получить информацию о доменной зоне по ID, отправьте запрос GET на `/api/v1/tlds/{tld_id}`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param tld_id: ID доменной зоны. (required)
        :type tld_id: object
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_arguments
    def get_tld_with_http_info(self, tld_id : Annotated[Any, Field(..., description="ID доменной зоны.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Получить информацию о доменной зоне по ID  # noqa: E501
    ...
    @validate_arguments
    def update_domain_request(self, request_id : Annotated[Any, Field(..., description="ID заявки на регистрацию/продление/трансфер домена.")], use : Use, **kwargs) -> CreateDomainRequest201Response:  # noqa: E501
    ...
    @validate_arguments
    def update_domain_request_with_http_info(self, request_id : Annotated[Any, Field(..., description="ID заявки на регистрацию/продление/трансфер домена.")], use : Use, **kwargs) -> ApiResponse:  # noqa: E501
        """Оплата/обновление заявки на регистрацию/продление/трансфер домена  # noqa: E501
