...
class SSHApi(object):
    ...
    @validate_arguments
    def add_key_to_server(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], add_key_to_server_request : AddKeyToServerRequest, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def add_key_to_server_with_http_info(self, server_id : Annotated[Any, Field(..., description="ID облачного сервера.")], add_key_to_server_request : AddKeyToServerRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Добавление SSH-ключей на сервер  # noqa: E501
