...
class FloatingIPApi(object):
    ...
    def bind_floating_ip(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], bind_floating_ip : BindFloatingIp, **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the bind_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def bind_floating_ip_with_http_info(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], bind_floating_ip : BindFloatingIp, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method bind_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['floating_ip_id']:
            _path_params['floating_ip_id'] = _params['floating_ip_id']
        ...
        _body_params = None
        if _params['bind_floating_ip'] is not None:
            _body_params = _params['bind_floating_ip']
    ...
    def create_floating_ip(self, create_floating_ip : CreateFloatingIp, **kwargs) -> CreateFloatingIp201Response:  # noqa: E501
        ...
        >>> thread = api.create_floating_ip(create_floating_ip, async_req=True)
        >>> result = thread.get()

        :param create_floating_ip: (required)
        :type create_floating_ip: CreateFloatingIp
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CreateFloatingIp201Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_floating_ip_with_http_info(create_floating_ip, **kwargs)  # noqa: E501
    ...
    def create_floating_ip_with_http_info(self, create_floating_ip : CreateFloatingIp, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.create_floating_ip_with_http_info(create_floating_ip, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CreateFloatingIp201Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['create_floating_ip'] is not None:
            _body_params = _params['create_floating_ip']
        ...
        _response_types_map = {
            '201': "CreateFloatingIp201Response",
            '400': None,
            '401': None,
            '403': None,
            '409': None,
    ...
    def delete_floating_ip(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def delete_floating_ip_with_http_info(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_floating_ip(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> CreateFloatingIp201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def get_floating_ip_with_http_info(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CreateFloatingIp201Response",
            '400': None,
            '401': None,
            '403': None,
            '404': None,
    ...
    @validate_arguments
    def get_floating_ips(self, **kwargs) -> GetFloatingIps200Response:  # noqa: E501
        """Получение списка плавающих IP  # noqa: E501

        Чтобы получить список плавающих IP, отправьте GET-запрос на `/api/v1/floating-ips`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_floating_ips(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetFloatingIps200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_floating_ips_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_floating_ips_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_floating_ips_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Получение списка плавающих IP  # noqa: E501
        ...
        >>> thread = api.get_floating_ips_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetFloatingIps200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_floating_ips" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def unbind_floating_ip(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the unbind_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def unbind_floating_ip_with_http_info(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method unbind_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def update_floating_ip(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], update_floating_ip : UpdateFloatingIp, **kwargs) -> CreateFloatingIp201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the update_floating_ip_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def update_floating_ip_with_http_info(self, floating_ip_id : Annotated[Any, Field(..., description="ID плавающего IP")], update_floating_ip : UpdateFloatingIp, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_floating_ip" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_floating_ip'] is not None:
            _body_params = _params['update_floating_ip']
