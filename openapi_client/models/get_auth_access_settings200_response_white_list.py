...
class GetAuthAccessSettings200ResponseWhiteList(BaseModel):
    """
    GetAuthAccessSettings200ResponseWhiteList
    """
    ips: Optional[Any] = Field(..., description="Список разрешенных IP-адресов.")
    countries: Optional[Any] = Field(..., description="Список разрешенных стран.")
    __properties = ["ips", "countries"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAuthAccessSettings200ResponseWhiteList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAuthAccessSettings200ResponseWhiteList:
        """Create an instance of GetAuthAccessSettings200ResponseWhiteList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAuthAccessSettings200ResponseWhiteList.parse_obj(obj)

        _obj = GetAuthAccessSettings200ResponseWhiteList.parse_obj({
            "ips": obj.get("ips"),
