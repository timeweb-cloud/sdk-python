...
class CreateToken201Response(BaseModel):
    """
    CreateToken201Response
    """
    api_key: CreatedApiKey = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateToken201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateToken201Response:
        """Create an instance of CreateToken201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateToken201Response.parse_obj(obj)

        _obj = CreateToken201Response.parse_obj({
            "api_key": CreatedApiKey.from_dict(obj.get("api_key")) if obj.get("api_key") is not None else None
        })
        return _obj
