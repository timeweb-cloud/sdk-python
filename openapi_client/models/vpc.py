...
class Vpc(BaseModel):
    ...
    Vpc
    """
    id: Optional[Any] = Field(..., description="Идентификатор сети.")
    ...
    __properties = ["id", "name", "subnet_v4", "location", "created_at", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Vpc:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Vpc:
        """Create an instance of Vpc from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Vpc.parse_obj(obj)
