...
class GetVPCServices200Response(BaseModel):
    """
    GetVPCServices200Response
    """
    meta: Meta = Field(...)
    services: Optional[Any] = Field(...)
    __properties = ["meta", "services"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVPCServices200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVPCServices200Response:
        """Create an instance of GetVPCServices200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetVPCServices200Response.parse_obj(obj)

        _obj = GetVPCServices200Response.parse_obj({
