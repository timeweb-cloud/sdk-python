...
class PresetsDbs(BaseModel):
    ...
    PresetsDbs
    """
    id: Optional[Any] = Field(None, description="Уникальный идентификатор для каждого экземпляра тарифа базы данных.")
    description: Optional[Any] = Field(None, description="Описание тарифа.")
    description_short: Optional[Any] = Field(None, description="Краткое описание тарифа.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PresetsDbs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PresetsDbs:
        """Create an instance of PresetsDbs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PresetsDbs.parse_obj(obj)

        _obj = PresetsDbs.parse_obj({
            "id": obj.get("id"),
