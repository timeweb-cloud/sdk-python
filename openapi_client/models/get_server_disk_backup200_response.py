...
class GetServerDiskBackup200Response(BaseModel):
    """
    GetServerDiskBackup200Response
    """
    backup: ServerBackup = Field(...)
    __properties = ["backup"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServerDiskBackup200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServerDiskBackup200Response:
        """Create an instance of GetServerDiskBackup200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetServerDiskBackup200Response.parse_obj(obj)

        _obj = GetServerDiskBackup200Response.parse_obj({
