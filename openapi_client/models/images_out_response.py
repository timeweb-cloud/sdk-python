...
class ImagesOutResponse(BaseModel):
    """
    ImagesOutResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImagesOutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImagesOutResponse:
        """Create an instance of ImagesOutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImagesOutResponse.parse_obj(obj)

        _obj = ImagesOutResponse.parse_obj({
