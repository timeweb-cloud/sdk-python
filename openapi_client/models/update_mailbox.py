...
class UpdateMailbox(BaseModel):
    ...
    """
    auto_reply: Optional[AutoReplyIsDisabled] = None
    spam_filter: Optional[SpamFilterIsDisabled] = None
    forwarding_incoming: Optional[ForwardingIncomingIsDisabled] = None
    forwarding_outgoing: Optional[ForwardingOutgoingIsDisabled] = None
    ...
    __properties = ["auto_reply", "spam_filter", "forwarding_incoming", "forwarding_outgoing", "comment", "password"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMailbox:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMailbox:
        """Create an instance of UpdateMailbox from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateMailbox.parse_obj(obj)

        _obj = UpdateMailbox.parse_obj({
            "auto_reply": AutoReplyIsDisabled.from_dict(obj.get("auto_reply")) if obj.get("auto_reply") is not None else None,
            "spam_filter": SpamFilterIsDisabled.from_dict(obj.get("spam_filter")) if obj.get("spam_filter") is not None else None,
            "forwarding_incoming": ForwardingIncomingIsDisabled.from_dict(obj.get("forwarding_incoming")) if obj.get("forwarding_incoming") is not None else None,
            "forwarding_outgoing": ForwardingOutgoingIsDisabled.from_dict(obj.get("forwarding_outgoing")) if obj.get("forwarding_outgoing") is not None else None,
