...
class CreateDatabaseCluster201Response(BaseModel):
    """
    CreateDatabaseCluster201Response
    """
    db: DatabaseCluster = Field(...)
    __properties = ["db"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDatabaseCluster201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDatabaseCluster201Response:
        """Create an instance of CreateDatabaseCluster201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDatabaseCluster201Response.parse_obj(obj)

        _obj = CreateDatabaseCluster201Response.parse_obj({
            "db": DatabaseCluster.from_dict(obj.get("db")) if obj.get("db") is not None else None
        })
        return _obj
