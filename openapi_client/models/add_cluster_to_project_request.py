...
class AddClusterToProjectRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddClusterToProjectRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddClusterToProjectRequest:
        """Create an instance of AddClusterToProjectRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddClusterToProjectRequest.parse_obj(obj)

        _obj = AddClusterToProjectRequest.parse_obj({
