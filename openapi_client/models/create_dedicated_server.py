...
class CreateDedicatedServer(BaseModel):
    """
    CreateDedicatedServer
    """
    plan_id: Optional[Any] = Field(..., description="Уникальный идентификатор списка дополнительных услуг выделенного сервера.")
    preset_id: Optional[Any] = Field(..., description="Уникальный идентификатор тарифа выделенного сервера.")
    os_id: Optional[Any] = Field(None, description="Уникальный идентификатор операционной системы, которая будет установлена на выделенный сервер.")
    cp_id: Optional[Any] = Field(None, description="Уникальный идентификатор панели управления, которая будет установлена на выделенный сервер.")
    bandwidth_id: Optional[Any] = Field(None, description="Уникальный идентификатор интернет-канала, который будет установлен на выделенный сервер.")
    network_drive_id: Optional[Any] = Field(None, description="Уникальный идентификатор сетевого диска, который будет установлен на выделенный сервер.")
    additional_ip_addr_id: Optional[Any] = Field(None, description="Уникальный идентификатор дополнительного IP-адреса, который будет установлен на выделенный сервер.")
    ...
    def payment_period_validate_enum(cls, value):
        ...
        if value not in ('P1M', 'P3M', 'P6M', 'P1Y'):
            raise ValueError("must be one of enum values ('P1M', 'P3M', 'P6M', 'P1Y')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDedicatedServer:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.payment_period is None and "payment_period" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDedicatedServer:
        """Create an instance of CreateDedicatedServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDedicatedServer.parse_obj(obj)

        _obj = CreateDedicatedServer.parse_obj({
