...
class GetServers200Response(BaseModel):
    """
    GetServers200Response
    """
    meta: Meta = Field(...)
    servers: Optional[Any] = Field(...)
    __properties = ["meta", "servers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetServers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetServers200Response:
        """Create an instance of GetServers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetServers200Response.parse_obj(obj)

        _obj = GetServers200Response.parse_obj({
