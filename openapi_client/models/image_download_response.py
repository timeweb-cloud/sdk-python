...
class ImageDownloadResponse(BaseModel):
    ...
    download: ImageDownloadAPI = Field(...)
    __properties = ["response_id", "download"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageDownloadResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageDownloadResponse:
        """Create an instance of ImageDownloadResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageDownloadResponse.parse_obj(obj)

        _obj = ImageDownloadResponse.parse_obj({
            "response_id": obj.get("response_id"),
            "download": ImageDownloadAPI.from_dict(obj.get("download")) if obj.get("download") is not None else None
        })
        return _obj
