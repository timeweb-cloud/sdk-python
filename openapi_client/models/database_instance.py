...
class DatabaseInstance(BaseModel):
    ...
    description: Optional[Any] = Field(..., description="Описание базы данных")
    __properties = ["id", "created_at", "name", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatabaseInstance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatabaseInstance:
        """Create an instance of DatabaseInstance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatabaseInstance.parse_obj(obj)

        _obj = DatabaseInstance.parse_obj({
            "id": obj.get("id"),
