...
class ClusterIn(BaseModel):
    ...
    ingress: Optional[Any] = Field(..., description="Логическое значение, которое показывает, использовать ли Ingress в кластере")
    ...
    __properties = ["name", "description", "ha", "k8s_version", "network_driver", "ingress", "preset_id", "worker_groups"]
