...
class GetAccountStatus200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccountStatus200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccountStatus200Response:
        """Create an instance of GetAccountStatus200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccountStatus200Response.parse_obj(obj)

        _obj = GetAccountStatus200Response.parse_obj({
