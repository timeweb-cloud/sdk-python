...
class CreateDomainMailboxRequest(BaseModel):
    """
    ...
    __properties = ["mailbox", "password", "comment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDomainMailboxRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDomainMailboxRequest:
        """Create an instance of CreateDomainMailboxRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDomainMailboxRequest.parse_obj(obj)

        _obj = CreateDomainMailboxRequest.parse_obj({
