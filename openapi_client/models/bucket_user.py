...
class BucketUser(BaseModel):
    """
    Пользователь хранилища
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор пользователя.")
    access_key: Optional[Any] = Field(..., description="Логин пользователя.")
    secret_key: Optional[Any] = Field(..., description="Пароль пользователя.")
    __properties = ["id", "access_key", "secret_key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BucketUser:
        """Create an instance of BucketUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketUser.parse_obj(obj)

        _obj = BucketUser.parse_obj({
            "id": obj.get("id"),
