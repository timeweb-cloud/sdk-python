...
class GetFinances200Response(BaseModel):
    """
    GetFinances200Response
    """
    finances: Finances = Field(...)
    __properties = ["finances"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFinances200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFinances200Response:
        """Create an instance of GetFinances200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFinances200Response.parse_obj(obj)

        _obj = GetFinances200Response.parse_obj({
            "finances": Finances.from_dict(obj.get("finances")) if obj.get("finances") is not None else None
        })
        return _obj
