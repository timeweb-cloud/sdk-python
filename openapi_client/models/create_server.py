...
class CreateServer(BaseModel):
    ...
    os_id: Optional[Any] = Field(None, description="Уникальный идентификатор операционной системы, которая будет установлена на облачный сервер. Нельзя передавать вместе с `image_id`.")
    ...
    software_id: Optional[Any] = Field(None, description="Уникальный идентификатор программного обеспечения сервера.")
    preset_id: Optional[Any] = Field(None, description="Уникальный идентификатор тарифа сервера. Нельзя передавать вместе с ключом `configurator`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateServer:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.software_id is None and "software_id" in self.__fields_set__:
            _dict['software_id'] = None
        ...
        # set to None if ssh_keys_ids (nullable) is None
        # and __fields_set__ contains the field
        if self.ssh_keys_ids is None and "ssh_keys_ids" in self.__fields_set__:
            _dict['ssh_keys_ids'] = None

        # set to None if is_local_network (nullable) is None
        # and __fields_set__ contains the field
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateServer:
        """Create an instance of CreateServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateServer.parse_obj(obj)

        _obj = CreateServer.parse_obj({
            "configuration": CreateServerConfiguration.from_dict(obj.get("configuration")) if obj.get("configuration") is not None else None,
