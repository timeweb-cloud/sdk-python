...
class CreateProject201Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProject201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProject201Response:
        """Create an instance of CreateProject201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProject201Response.parse_obj(obj)

        _obj = CreateProject201Response.parse_obj({
