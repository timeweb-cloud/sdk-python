...
class DedicatedServerPreset(BaseModel):
    ...
    Выделенный сервер
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор тарифа выделенного сервера.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DedicatedServerPreset:
    ...
    def to_dict(self):
        ...
        # set to None if is_ipmi_enabled (nullable) is None
        # and __fields_set__ contains the field
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DedicatedServerPreset:
        """Create an instance of DedicatedServerPreset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DedicatedServerPreset.parse_obj(obj)

        _obj = DedicatedServerPreset.parse_obj({
            "id": obj.get("id"),
            ...
            "price": obj.get("price"),
            "memory": DedicatedServerPresetMemory.from_dict(obj.get("memory")) if obj.get("memory") is not None else None,
