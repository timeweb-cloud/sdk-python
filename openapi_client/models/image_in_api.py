...
class ImageInAPI(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageInAPI:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageInAPI:
        """Create an instance of ImageInAPI from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageInAPI.parse_obj(obj)

        _obj = ImageInAPI.parse_obj({
            "name": obj.get("name"),
