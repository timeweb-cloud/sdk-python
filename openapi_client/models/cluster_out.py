...
class ClusterOut(BaseModel):
    ...
    ClusterOut
    """
    id: Optional[Any] = Field(..., description="Уникальный идентификатор кластера")
    ...
    ha: Optional[Any] = Field(..., description="Описание появится позже")
    ...
    __properties = ["id", "name", "created_at", "status", "description", "ha", "k8s_version", "network_driver", "ingress", "preset_id", "cpu", "ram", "disk"]
